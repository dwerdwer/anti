 ...
 */
#define create_queue(pSTL,...) _create_queue(pSTL,#__VA_ARGS__) 
 ...
 */
#define queue_push(pSTL,pque_deque, elem) _queue_push((pSTL),(pque_deque), (elem))
 ...
 */
extern void queue_init(cSTL* pSTL,queue_t* pque_queue);
 ...
 */
extern void queue_init_copy(cSTL* pSTL,queue_t* pque_dest, const queue_t* cpque_src);
 ...
 */
extern void queue_destroy(cSTL* pSTL,queue_t* pque_queue);
 ...
 */
extern void queue_assign(cSTL* pSTL,queue_t* pque_dest, const queue_t* cpque_src);
 ...
 */
extern void queue_pop(cSTL* pSTL,queue_t* pque_queue);
 ...
 */
extern bool_t queue_equal(cSTL* pSTL,const queue_t* cpque_first, const queue_t* cpque_second);
 ...
 */
extern bool_t queue_not_equal(cSTL* pSTL,const queue_t* cpque_first, const queue_t* cpque_second);
 ...
 */
extern bool_t queue_less(cSTL* pSTL,const queue_t* cpque_first, const queue_t* cpque_second);
 ...
 */
extern bool_t queue_less_equal(cSTL* pSTL,const queue_t* cpque_first, const queue_t* cpque_second);
 ...
 *          undefined. if cpque_first == cpque_second, then return false.
 */
extern bool_t queue_greater(cSTL* pSTL,const queue_t* cpque_first, const queue_t* cpque_second);
 ...
 *          undefined. if cpque_first == cpque_second, then return true.
 */
extern bool_t queue_greater_equal(cSTL* pSTL,const queue_t* cpque_first, const queue_t* cpque_second);
