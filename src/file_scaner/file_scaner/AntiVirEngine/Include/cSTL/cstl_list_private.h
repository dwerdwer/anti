 ...
 */
extern list_t* _create_list(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_list_auxiliary(cSTL* pSTL,list_t* plist_list, const char* s_typename);
 ...
 */
extern void _list_init_elem(cSTL* pSTL,list_t* plist_list, size_t t_count, ...);
 ...
 *          not in use. list container must be created by create_list, otherwise the behavior is undefined.
 */
extern void _list_init_elem_varg(cSTL* pSTL,list_t* plist_list, size_t t_count, va_list val_elemlist);
 ...
 */
extern void _list_destroy_auxiliary(cSTL* pSTL,list_t* plist_list);
 ...
 */
extern void _list_assign_elem(cSTL* pSTL,list_t* plist_list, size_t t_count, ...);
 ...
 *          in use, others are not in use.
 */
extern void _list_assign_elem_varg(cSTL* pSTL,list_t* plist_list, size_t t_count, va_list val_elemlist);
 ...
 *          in use, others are not in use.
 */
extern void _list_push_back(cSTL* pSTL,list_t* plist_list, ...);
 ...
 *          in use, others are not in use.
 */
extern void _list_push_back_varg(cSTL* pSTL,list_t* plist_list, va_list val_elemlist);
 ...
 *          in use, others are not in use.
 */
extern void _list_push_front(cSTL* pSTL,list_t* plist_list, ...);
 ...
 *          in use, others are not in use.
 */
extern void _list_push_front_varg(cSTL* pSTL,list_t* plist_list, va_list val_elemlist);
 ...
 *          element.
 */
extern void _list_resize_elem(cSTL* pSTL,list_t* plist_list, size_t t_resize, ...);
 ...
 */
extern void _list_resize_elem_varg(cSTL* pSTL,list_t* plist_list, size_t t_resize, va_list val_elemlist);
 ...
 *          then does nothing.
 */
extern void _list_remove(cSTL* pSTL,list_t* plist_list, ...);
 ...
 *          then does nothing.
 */
extern void _list_remove_varg(cSTL* pSTL,list_t* plist_list, va_list val_elemlist);
 ...
 *          in use.
 */
extern list_iterator_t _list_insert_n(cSTL* pSTL,list_t* plist_list, list_iterator_t t_pos, size_t t_count, ...);
 ...
 */
extern list_iterator_t _list_insert_n_varg(cSTL* pSTL,list_t* plist_list, list_iterator_t t_pos, size_t t_count, va_list val_elemlist);
 ...
 */
extern void _list_init_elem_auxiliary(cSTL* pSTL,list_t* plist_list, void* pv_elem);
