 ...
 */
extern _hashtable_t* _create_hashtable(cSTL* pSTL,const char* s_typename);
 ...
 */
extern void _hashtable_init(cSTL* pSTL,_hashtable_t* pt_hashtable, size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void _hashtable_init_copy(cSTL* pSTL,_hashtable_t* pt_dest, const _hashtable_t* cpt_src);
 ...
 */
extern void _hashtable_init_copy_equal_range(cSTL* pSTL,
 ...
 *          function is used.
 */
extern void _hashtable_init_copy_equal_array(cSTL* pSTL,
 ...
 *          default compare function is used.
 */
extern void _hashtable_init_copy_unique_range(cSTL* pSTL,
    _hashtable_t* pt_dest, iterator_t it_begin, iterator_t it_end, size_t t_bucketcount,
    unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 *          function is used.
 */
extern void _hashtable_init_copy_unique_array(cSTL* pSTL,
    _hashtable_t* pt_dest, const void* cpv_array, size_t t_count, size_t t_bucketcount,
    unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void _hashtable_destroy(cSTL* pSTL,_hashtable_t* pt_hashtable);
 ...
 */
extern void _hashtable_assign(cSTL* pSTL,_hashtable_t* pt_dest, const _hashtable_t* cpt_src);
 ...
 *          behavior is undefined.
 */
extern _hashtable_iterator_t _hashtable_find(cSTL* pSTL,const _hashtable_t* cpt_hashtable, const void* cpv_value);
 ...
 *          is undefined.
 */
extern void _hashtable_clear(cSTL* pSTL,_hashtable_t* pt_hashtable);
 ...
 *          behavior is undefined.
 */
extern size_t _hashtable_count(cSTL* pSTL,const _hashtable_t* cpt_hashtable, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern range_t _hashtable_equal_range(cSTL* pSTL,const _hashtable_t* cpt_hashtable, const void* cpv_value);
 ...
 */
extern bool_t _hashtable_equal(cSTL* pSTL,const _hashtable_t* cpt_first, const _hashtable_t* cpt_second);
 ...
 */
extern bool_t _hashtable_not_equal(cSTL* pSTL,const _hashtable_t* cpt_first, const _hashtable_t* cpt_second);
 ...
 */
extern bool_t _hashtable_less(cSTL* pSTL,const _hashtable_t* cpt_first, const _hashtable_t* cpt_second);
 ...
 */
extern bool_t _hashtable_less_equal(cSTL* pSTL,const _hashtable_t* cpt_first, const _hashtable_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return false.
 */
extern bool_t _hashtable_greater(cSTL* pSTL,const _hashtable_t* cpt_first, const _hashtable_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return true.
 */
extern bool_t _hashtable_greater_equal(cSTL* pSTL,const _hashtable_t* cpt_first, const _hashtable_t* cpt_second);
 ...
 *          is undefined.
 */
extern void _hashtable_resize(cSTL* pSTL,_hashtable_t* pt_hashtable, size_t t_resize);
 ...
 *          behavior is undefined.
 */
extern _hashtable_iterator_t _hashtable_insert_unique(cSTL* pSTL,_hashtable_t* pt_hashtable, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern _hashtable_iterator_t _hashtable_insert_equal(cSTL* pSTL,_hashtable_t* pt_hashtable, const void* cpv_value);
 ...
 */
extern void _hashtable_insert_unique_range(cSTL* pSTL,_hashtable_t* pt_hashtable, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void _hashtable_insert_unique_array(cSTL* pSTL,_hashtable_t* pt_hashtable, const void* cpv_array, size_t t_count);
 ...
 *          [it_begin, it_end) must be valid range, otherwise the behavior is undefine.
 */
extern void _hashtable_insert_equal_range(cSTL* pSTL,_hashtable_t* pt_hashtable, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void _hashtable_insert_equal_array(cSTL* pSTL,_hashtable_t* pt_hashtable, const void* cpv_array, size_t t_count);
 ...
 */
extern void _hashtable_erase_pos(cSTL* pSTL,_hashtable_t* pt_hashtable, _hashtable_iterator_t t_pos);
 ...
 */
extern void _hashtable_erase_range(cSTL* pSTL,
 ...
 */
extern size_t _hashtable_erase(cSTL* pSTL,_hashtable_t* pt_hashtable, const void* cpv_value);
 ...
 */
extern void _hashtable_swap(cSTL* pSTL,_hashtable_t* pt_first, _hashtable_t* pt_second);
