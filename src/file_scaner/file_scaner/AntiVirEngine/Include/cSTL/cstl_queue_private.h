 ...
 */
extern queue_t* _create_queue(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_queue_auxiliary(cSTL* pSTL,queue_t* pque_queue, const char* s_typename);
 ...
 */
extern void _queue_destroy_auxiliary(cSTL* pSTL,queue_t* pque_queue);
 ...
 */
extern void _queue_push(cSTL* pSTL,queue_t* pque_pqueue, ...);
 ...
 *          in use, others are not in use.
 */
extern void _queue_push_varg(cSTL* pSTL,queue_t* pt_queue, va_list val_elemlist);
