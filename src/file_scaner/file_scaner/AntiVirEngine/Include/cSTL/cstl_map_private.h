 ...
 */
extern map_t* _create_map(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_map_auxiliary(cSTL* pSTL,map_t* pmap_map, const char* s_typename);
 ...
 */
extern void _map_destroy_auxiliary(cSTL* pSTL,map_t* pmap_map);
 ...
 */
extern map_iterator_t _map_find(cSTL* pSTL,const map_t* cpmap_map, ...);
 ...
 *          is undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern map_iterator_t _map_find_varg(cSTL* pSTL,const map_t* cpmap_map, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _map_count(cSTL* pSTL,const map_t* cpmap_map, ...);
 ...
 *          is undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _map_count_varg(cSTL* pSTL,const map_t* cpmap_map, va_list val_elemlist);
 ...
 */
extern map_iterator_t _map_lower_bound(cSTL* pSTL,const map_t* cpmap_map, ...);
 ...
 *          undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern map_iterator_t _map_lower_bound_varg(cSTL* pSTL,const map_t* cpmap_map, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern map_iterator_t _map_upper_bound(cSTL* pSTL,const map_t* cpmap_map, ...);
 ...
 *          undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern map_iterator_t _map_upper_bound_varg(cSTL* pSTL,const map_t* cpmap_map, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern range_t _map_equal_range(cSTL* pSTL,const map_t* cpmap_map, ...);
 ...
 *          undefined. the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern range_t _map_equal_range_varg(cSTL* pSTL,const map_t* cpmap_map, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern void* _map_at(cSTL* pSTL,map_t* pmap_map, ...);
 ...
 *          undefined. 
 */
extern void* _map_at_varg(cSTL* pSTL,map_t* pmap_map, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _map_erase(cSTL* pSTL,map_t* pmap_map, ...);
 ...
 *          undefined. 
 */
extern size_t _map_erase_varg(cSTL* pSTL,map_t* pmap_map, va_list val_elemlist);
 ...
 */
extern void _map_init_elem_auxiliary(cSTL* pSTL,map_t* pmap_map, void* pv_value);
