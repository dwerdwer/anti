 ...
 */
#define create_hash_map(pSTL,...) _create_hash_map(pSTL,#__VA_ARGS__)
 ...
 */
#define hash_map_find(pSTL,cphmap_map, key_elem) _hash_map_find((pSTL),(cphmap_map), (key_elem))
 ...
 *          the type of specific element and cphmap_map must be same, otherwise the behavior is undefined.
 */
#define hash_map_count(pSTL,cphmap_map, key_elem) _hash_map_count((pSTL),(cphmap_map), (key_elem))
 ...
 *          the type of specific element and cphmap_map must be same, otherwise the behavior is undefined.
 */
#define hash_map_equal_range(pSTL,cphmap_map, key_elem) _hash_map_equal_range((pSTL),(cphmap_map), (key_elem))
 ...
 *          undefined. 
 */
#define hash_map_at(pSTL,phmap_map, key_elem) _hash_map_at((pSTL),(phmap_map), (key_elem))
 ...
 */
#define hash_map_erase(pSTL,phmap_map, key_elem) _hash_map_erase((pSTL),(phmap_map), (key_elem))
 ...
 */
extern void hash_map_init(cSTL* pSTL,hash_map_t* phmap_map);
 ...
 */
extern void hash_map_init_ex(cSTL* pSTL,hash_map_t* phmap_map, size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void hash_map_init_copy(cSTL* pSTL,hash_map_t* phmap_dest, const hash_map_t* cphmap_src);
 ...
 *          is undefined.
 */
extern void hash_map_init_copy_range(cSTL* pSTL,hash_map_t* phmap_dest, iterator_t t_begin, iterator_t t_end);
 ...
 */
extern void hash_map_init_copy_array(cSTL* pSTL,hash_map_t* phmap_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_map_init_copy_range_ex(cSTL* pSTL,hash_map_t* phmap_dest, iterator_t t_begin, iterator_t t_end,
 ...
 */
extern void hash_map_init_copy_array_ex(cSTL* pSTL,hash_map_t* phmap_dest, const void* cpv_array, size_t t_count,
    size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void hash_map_destroy(cSTL* pSTL,hash_map_t* phmap_map);
 ...
 */
extern void hash_map_assign(cSTL* pSTL,hash_map_t* phmap_dest, const hash_map_t* cphmap_src);
 ...
 * @remarks if cphmap_map == NULL, the behavior is undefined. cphmap_map must be initialized, otherwise the behavior is undefined.
 */
extern void hash_map_resize(cSTL* pSTL,hash_map_t* phmap_map, size_t t_resize);
 ...
 */
extern bool_t hash_map_equal(cSTL* pSTL,const hash_map_t* cphmap_first, const hash_map_t* cphmap_second);
 ...
 */
extern bool_t hash_map_not_equal(cSTL* pSTL,const hash_map_t* cphmap_first, const hash_map_t* cphmap_second);
 ...
 */
extern bool_t hash_map_less(cSTL* pSTL,const hash_map_t* cphmap_first, const hash_map_t* cphmap_second);
 ...
 */
extern bool_t hash_map_less_equal(cSTL* pSTL,const hash_map_t* cphmap_first, const hash_map_t* cphmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return false.
 */
extern bool_t hash_map_greater(cSTL* pSTL,const hash_map_t* cphmap_first, const hash_map_t* cphmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return true.
 */
extern bool_t hash_map_greater_equal(cSTL* pSTL,const hash_map_t* cphmap_first, const hash_map_t* cphmap_second);
 ...
 *          the type of specific element and cphmap_map must be same, otherwise the behavior is undefined.
 */
extern hash_map_iterator_t hash_map_insert(cSTL* pSTL,hash_map_t* phmap_map, const pair_t* cpt_pair);
 ...
 */
extern void hash_map_insert_range(cSTL* pSTL,hash_map_t* phmap_map, iterator_t t_begin, iterator_t t_end);
 ...
 */
extern void hash_map_insert_array(cSTL* pSTL,hash_map_t* phmap_map, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_map_erase_pos(cSTL* pSTL,hash_map_t* phmap_map, hash_map_iterator_t t_pos);
 ...
 */
extern void hash_map_erase_range(cSTL* pSTL,hash_map_t* phmap_map, hash_map_iterator_t t_begin, hash_map_iterator_t t_end);
 ...
 */
extern void hash_map_clear(cSTL* pSTL,hash_map_t* phmap_map);
