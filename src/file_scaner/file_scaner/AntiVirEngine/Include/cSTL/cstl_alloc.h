 ...
 */
extern void* _alloc_allocate(cSTL* pSTL,_alloc_t* pt_allocator, size_t t_size, size_t t_count);
 ...
 */
extern void _alloc_deallocate(cSTL* pSTL,_alloc_t* pt_allocator, void* pv_allocmem, size_t t_size, size_t t_count);
