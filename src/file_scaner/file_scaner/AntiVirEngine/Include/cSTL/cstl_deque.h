 ...
 */
#define create_deque(pSTL,...) _create_deque(pSTL,#__VA_ARGS__)
 ...
 */
#define deque_init_elem(pSTL,pdeq_deque, t_count, elem) _deque_init_elem((pSTL),(pdeq_deque), (t_count), (elem))
 ...
 */
#define deque_assign_elem(pSTL,pdeq_deque, t_count, elem) _deque_assign_elem((pSTL),(pdeq_deque), (t_count), (elem))
 ...
 *          element and deque element type must be same, otherwise the behavior is undefined.
 */
#define deque_push_back(pSTL,pdeq_deque, elem) _deque_push_back((pSTL),(pdeq_deque), (elem))
 ...
 *          element and deque element type must be same, otherwise the behavior is undefined.
 */
#define deque_push_front(pSTL,pdeq_deque, elem) _deque_push_front((pSTL),(pdeq_deque), (elem))
 ...
 */
#define deque_resize_elem(pSTL,pdeq_deque, t_resize, elem) _deque_resize_elem((pSTL),(pdeq_deque), (t_resize), (elem))
 ...
 */
#define deque_insert(pSTL,pdeq_deque, it_pos, elem) _deque_insert_n((pSTL),(pdeq_deque), (it_pos), 1, (elem))
 ...
 *          element type must be same, otherwise the behavior is undefined.
 */
#define deque_insert_n(pSTL,pdeq_deque, it_pos, t_count, elem) _deque_insert_n((pSTL),(pdeq_deque), (it_pos), (t_count), (elem))
 ...
 */
extern void deque_init(cSTL* pSTL,deque_t* pdeq_deque);
 ...
 *          the behavior is undefine.
 */
extern void deque_init_n(cSTL* pSTL,deque_t* pdeq_deque, size_t t_count);
 ...
 *          otherwise the behavior is undefined.
 */
extern void deque_destroy(cSTL* pSTL,deque_t* pdeq_deque);
 ...
 */
extern void deque_init_copy(cSTL* pSTL,deque_t* pdeq_dest, const deque_t* cpdeq_src);
 ...
 */
extern void deque_init_copy_range(cSTL* pSTL,deque_t* pdeq_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void deque_assign_range(cSTL* pSTL,deque_t* pdeq_deque, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void deque_assign_array(cSTL* pSTL,deque_t* pdeq_deque, const void* cpv_array, size_t t_count);
 ...
 */
extern bool_t deque_equal(cSTL* pSTL,const deque_t* cpdeq_first, const deque_t* cpdeq_second);
 ...
 */
extern bool_t deque_not_equal(cSTL* pSTL,const deque_t* cpdeq_first, const deque_t* cpdeq_second);
 ...
 */
extern bool_t deque_less(cSTL* pSTL,const deque_t* cpdeq_first, const deque_t* cpdeq_second);
 ...
 */
extern bool_t deque_less_equal(cSTL* pSTL,const deque_t* cpdeq_first, const deque_t* cpdeq_second);
 ...
 *          undefined. if cpdeq_first == cpdeq_second, then return true.
 */
extern bool_t deque_greater_equal(cSTL* pSTL,const deque_t* cpdeq_first, const deque_t* cpdeq_second);
 ...
 */
extern void deque_swap(cSTL* pSTL,deque_t* pdeq_first, deque_t* pdeq_second);
 ...
 */
extern void deque_pop_back(cSTL* pSTL,deque_t* pdeq_deque);
 ...
 *          is undefined. if deque is empty, then the behavior is undefined.
 */
extern void deque_pop_front(cSTL* pSTL,deque_t* pdeq_deque);
 ...
 */
extern deque_iterator_t deque_erase(cSTL* pSTL,deque_t* pdeq_deque, deque_iterator_t it_pos);
 ...
 */
extern deque_iterator_t deque_erase_range(cSTL* pSTL,deque_t* pdeq_deque, deque_iterator_t it_begin, deque_iterator_t it_end);
 ...
 *          is undefined.
 */
extern void deque_clear(cSTL* pSTL,deque_t* pdeq_deque);
 ...
 */
extern void deque_resize(cSTL* pSTL,deque_t* pdeq_deque, size_t t_resize);
