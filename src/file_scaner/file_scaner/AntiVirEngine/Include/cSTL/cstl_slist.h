 ...
 */
#define create_slist(pSTL,...) _create_slist(pSTL,#__VA_ARGS__)
 ...
 */
#define slist_init_elem(pSTL,pslist_slist, t_count, elem) _slist_init_elem((pSTL),(pslist_slist), (t_count), (elem))
 ...
 */
#define slist_assign_elem(pSTL,pslist_slist, t_count, elem) _slist_assign_elem((pSTL),(pslist_slist), (t_count), (elem))
 ...
 */
#define slist_push_front(pSTL,pslist_slist, elem) _slist_push_front((pSTL),(pslist_slist), (elem))
 ...
 *          then does nothing.
 */
#define slist_remove(pSTL,pslist_slist, elem) _slist_remove((pSTL),(pslist_slist), (elem))
 ...
 *          element.
 */
#define slist_resize_elem(pSTL,pslist_slist, t_resize, elem) _slist_resize_elem((pSTL),(pslist_slist), (t_resize), (elem))
 ...
 */
#define slist_insert(pSTL,pslist_slist, it_pos, elem) _slist_insert((pSTL),(pslist_slist), (it_pos), (elem))
 ...
 *          element type must be same, otherwise the behavior is undefined.
 */
#define slist_insert_n(pSTL,pslist_slist, it_pos, t_count, elem) _slist_insert_n((pSTL),(pslist_slist), (it_pos), (t_count), (elem))
 ...
 *          in use.
 */
#define slist_insert_after(pSTL,pslist_slist, it_pos, elem) _slist_insert_after((pSTL),(pslist_slist), (it_pos), (elem))
 ...
 *          in use.
 */
#define slist_insert_after_n(pSTL,pslist_slist, it_pos, t_count, elem)\
    _slist_insert_after_n((pSTL),(pslist_slist), (it_pos), (t_count), (elem))
 ...
 */
extern void slist_init(cSTL* pSTL,slist_t* pslist_slist);
 ...
 *          the behavior is undefine.
 */
extern void slist_init_n(cSTL* pSTL,slist_t* pslist_slist, size_t t_count);
 ...
 */
extern void slist_init_copy(cSTL* pSTL,slist_t* pslist_dest, const slist_t* cpslist_src);
 ...
 */
extern void slist_init_copy_range(cSTL* pSTL,slist_t* pslist_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void slist_destroy(cSTL* pSTL,slist_t* pslist_slist);
 ...
 */
extern void slist_assign(cSTL* pSTL,slist_t* pslist_dest, const slist_t* cpslist_src);
 ...
 */
extern void slist_assign_range(cSTL* pSTL,slist_t* pslist_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void slist_swap(cSTL* pSTL,slist_t* pslist_first, slist_t* pslist_second);
 ...
 */
extern void slist_pop_front(cSTL* pSTL,slist_t* pslist_slist);
 ...
 */
extern void slist_insert_range(cSTL* pSTL,
 ...
 */
extern void slist_insert_array(cSTL* pSTL,
 ...
 */
extern void slist_insert_after_range(cSTL* pSTL,
    slist_t* pslist_slist, slist_iterator_t it_pos, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void slist_insert_after_array(cSTL* pSTL,
    slist_t* pslist_slist, slist_iterator_t it_pos, const void* cpv_array, size_t t_count);
 ...
 */
extern slist_iterator_t slist_erase(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos);
 ...
 *          behavior is undefined.
 */
extern slist_iterator_t slist_erase_range(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_begin, slist_iterator_t it_end);
 ...
 */
extern slist_iterator_t slist_erase_after(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos);
 ...
 */
extern slist_iterator_t slist_erase_after_range(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_begin, slist_iterator_t it_end);
 ...
 */
extern void slist_splice(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos, slist_t* pslist_src);
 ...
 */
extern void slist_splice_pos(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos, slist_t* pslist_src, slist_iterator_t it_src);
 ...
 */
extern void slist_splice_range(cSTL* pSTL,
 ...
 *           or it_pos = iterator_next(it_src), then the function does nothing.
 */
extern void slist_splice_after_pos(cSTL* pSTL,
 ...
 *           or it_pos = it_end, then the function does nothing.
 */
extern void slist_splice_after_range(cSTL* pSTL,
    slist_t* pslist_slist, slist_iterator_t it_pos, slist_t* pslist_src, slist_iterator_t it_begin, slist_iterator_t it_end);
 ...
 *          unary predicate.
 */
extern void slist_remove_if(cSTL* pSTL,slist_t* pslist_slist, unary_function_t ufun_op);
 ...
 *          bt deleted.
 */
extern void slist_unique(cSTL* pSTL,slist_t* pslist_slist);
 ...
 */
extern void slist_unique_if(cSTL* pSTL,slist_t* pslist_slist, binary_function_t bfun_op);
 ...
 *          undefined.
 */
extern void slist_reverse(cSTL* pSTL,slist_t* pslist_slist);
 ...
 *          undefined.
 */
extern void slist_sort(cSTL* pSTL,slist_t* pslist_slist);
 ...
 */
extern void slist_sort_if(cSTL* pSTL,slist_t* pslist_slist, binary_function_t bfun_op);
 ...
 */
extern void slist_merge_if(cSTL* pSTL,slist_t* pslist_dest, slist_t* pslist_src, binary_function_t bfun_op);
 ...
 */
extern void slist_resize(cSTL* pSTL,slist_t* pslist_slist, size_t t_resize);
 ...
 *          is undefined.
 */
extern void slist_clear(cSTL* pSTL,slist_t* pslist_slist);
 ...
 */
extern bool_t slist_equal(cSTL* pSTL,const slist_t* cpslist_first, const slist_t* cpslist_second);
 ...
 */
extern bool_t slist_not_equal(cSTL* pSTL,const slist_t* cpslist_first, const slist_t* cpslist_second);
 ...
 */
extern bool_t slist_less(cSTL* pSTL,const slist_t* cpslist_first, const slist_t* cpslist_second);
 ...
 */
extern bool_t slist_less_equal(cSTL* pSTL,const slist_t* cpslist_first, const slist_t* cpslist_second);
 ...
 *          undefined. if cpslist_first == cpslist_second, then return false.
 */
extern bool_t slist_greater(cSTL* pSTL,const slist_t* cpslist_first, const slist_t* cpslist_second);
 ...
 *          undefined. if cpslist_first == cpslist_second, then return true.
 */
extern bool_t slist_greater_equal(cSTL* pSTL,const slist_t* cpslist_first, const slist_t* cpslist_second);
