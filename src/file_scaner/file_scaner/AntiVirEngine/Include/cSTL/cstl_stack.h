 ...
 */
#define create_stack(pSTL,...) _create_stack(pSTL,#__VA_ARGS__) 
 ...
 */
#define stack_push(pSTL,psk_stack, elem) _stack_push((pSTL),(psk_stack), (elem))
 ...
 */
extern void stack_init(cSTL* pSTL,stack_t* psk_stack);
 ...
 */
extern void stack_init_copy(cSTL* pSTL,stack_t* psk_dest, const stack_t* cpsk_src);
 ...
 */
extern void stack_destroy(cSTL* pSTL,stack_t* psk_stack);
 ...
 */
extern void stack_assign(cSTL* pSTL,stack_t* psk_dest, const stack_t* cpsk_src);
 ...
 */
extern void stack_pop(cSTL* pSTL,stack_t* psk_stack);
 ...
 */
extern bool_t stack_equal(cSTL* pSTL,const stack_t* cpsk_first, const stack_t* cpsk_second);
 ...
 */
extern bool_t stack_not_equal(cSTL* pSTL,const stack_t* cpsk_first, const stack_t* cpsk_second);
 ...
 */
extern bool_t stack_less(cSTL* pSTL,const stack_t* cpsk_first, const stack_t* cpsk_second);
 ...
 */
extern bool_t stack_less_equal(cSTL* pSTL,const stack_t* cpsk_first, const stack_t* cpsk_second);
 ...
 *          undefined. if cpsk_first == cpsk_second, then return false.
 */
extern bool_t stack_greater(cSTL* pSTL,const stack_t* cpsk_first, const stack_t* cpsk_second);
 ...
 *          undefined. if cpsk_first == cpsk_second, then return true.
 */
extern bool_t stack_greater_equal(cSTL* pSTL,const stack_t* cpsk_first, const stack_t* cpsk_second);
