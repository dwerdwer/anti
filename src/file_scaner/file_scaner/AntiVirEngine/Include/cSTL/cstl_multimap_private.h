 ...
 */
extern multimap_t* _create_multimap(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_multimap_auxiliary(cSTL* pSTL,multimap_t* pmmap_map, const char* s_typename);
 ...
 */
extern void _multimap_destroy_auxiliary(cSTL* pSTL,multimap_t* pmmap_map);
 ...
 */
extern multimap_iterator_t _multimap_find(cSTL* pSTL,const multimap_t* cpmmap_map, ...);
 ...
 *          is undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern multimap_iterator_t _multimap_find_varg(cSTL* pSTL,const multimap_t* cpmmap_map, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _multimap_count(cSTL* pSTL,const multimap_t* cpmmap_map, ...);
 ...
 *          is undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _multimap_count_varg(cSTL* pSTL,const multimap_t* cpmmap_map, va_list val_elemlist);
 ...
 */
extern multimap_iterator_t _multimap_lower_bound(cSTL* pSTL,const multimap_t* cpmmap_map, ...);
 ...
 *          undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern multimap_iterator_t _multimap_lower_bound_varg(cSTL* pSTL,const multimap_t* cpmmap_map, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern multimap_iterator_t _multimap_upper_bound(cSTL* pSTL,const multimap_t* cpmmap_map, ...);
 ...
 *          undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern multimap_iterator_t _multimap_upper_bound_varg(cSTL* pSTL,const multimap_t* cpmmap_map, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern range_t _multimap_equal_range(cSTL* pSTL,const multimap_t* cpmmap_map, ...);
 ...
 *          undefined. the type of specific element and cpmmap_map must be same, otherwise the behavior is undefined.
 */
extern range_t _multimap_equal_range_varg(cSTL* pSTL,const multimap_t* cpmmap_map, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _multimap_erase(cSTL* pSTL,multimap_t* pmmap_map, ...);
 ...
 *          undefined. 
 */
extern size_t _multimap_erase_varg(cSTL* pSTL,multimap_t* pmmap_map, va_list val_elemlist);
 ...
 */
extern void _multimap_init_elem_auxiliary(cSTL* pSTL,multimap_t* pmmap_map, void* pv_value);
