 ...
 */
extern basic_string_t* _create_basic_string(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_basic_string_auxiliary(cSTL* pSTL,basic_string_t* pt_basic_string, const char* s_typename);
 ...
 */
extern void _basic_string_init_elem(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_count, ...);
 ...
 *          not in use. basic_string container must be created by create_basic_string, otherwise the behavior is undefined.
 */
extern void _basic_string_init_elem_varg(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_count, va_list val_elemlist);
 ...
 */
extern void _basic_string_destroy_auxiliary(cSTL* pSTL,basic_string_t* pt_basic_string);
 ...
 *          NPOS.
 */
extern size_t _basic_string_find_elem(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, ...);
 ...
 *          NPOS.
 */
extern size_t _basic_string_find_elem_varg(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, va_list val_elemlist);
 ...
 */
extern size_t _basic_string_rfind_elem(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, ...);
 ...
 *          from the last element.
 */
extern size_t _basic_string_rfind_elem_varg(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, va_list val_elemlist);
 ...
 *          NPOS.
 */
extern size_t _basic_string_find_first_not_of_elem(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, ...);
 ...
 *          NPOS.
 */
extern size_t _basic_string_find_first_not_of_elem_varg(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, va_list val_elemlist);
 ...
 *          from the last element.
 */
extern size_t _basic_string_find_last_not_of_elem(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, ...);
 ...
 *          from the last element.
 */
extern size_t _basic_string_find_last_not_of_elem_varg(cSTL* pSTL,const basic_string_t* cpt_basic_string, size_t t_pos, va_list val_elemlist);
 ...
 */
extern void _basic_string_connect_elem(cSTL* pSTL,basic_string_t* pt_basic_string, ...);
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void _basic_string_connect_elem_varg(cSTL* pSTL,basic_string_t* pt_basic_string, va_list val_elemlist);
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void _basic_string_push_back(cSTL* pSTL,basic_string_t* pt_basic_string, ...);
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void _basic_string_push_back_varg(cSTL* pSTL,basic_string_t* pt_basic_string, va_list val_elemlist);
 ...
 */
extern void _basic_string_pop_back(cSTL* pSTL,basic_string_t* pt_basic_string);
 ...
 *          element.
 */
extern void _basic_string_resize(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_resize, ...);
 ...
 */
extern void _basic_string_resize_varg(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_resize, va_list val_elemlist);
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void _basic_string_assign_elem(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_count, ...);
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void _basic_string_assign_elem_varg(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_count, va_list val_elemlist);
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void _basic_string_append_elem(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_count, ...);
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void _basic_string_append_elem_varg(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_count, va_list val_elemlist);
 ...
 */
extern basic_string_iterator_t _basic_string_insert(cSTL* pSTL,basic_string_t* pt_basic_string, basic_string_iterator_t it_pos, ...);
 ...
 *          others are not in use.
 */
extern basic_string_iterator_t _basic_string_insert_n(cSTL* pSTL,
 ...
 */
extern basic_string_iterator_t _basic_string_insert_n_varg(cSTL* pSTL,
 ...
 *          others are not in use.
 */
extern void _basic_string_insert_elem(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_pos, size_t t_count, ...);
 ...
 *          others are not in use. the inserted element is from variable argument list.
 */
extern void _basic_string_insert_elem_varg(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_pos, size_t t_count, va_list val_elemlist);
 ...
 *          others are not in use. the inserted element is from variable argument list.
 */
extern void _basic_string_range_replace_elem(cSTL* pSTL,
 ...
 *          others are not in use. the inserted element is from variable argument list.
 */
extern void _basic_string_range_replace_elem_varg(cSTL* pSTL,
 ...
 */
extern void _basic_string_replace_elem(cSTL* pSTL,
 ...
 *          from variable argument list.
 */
extern void _basic_string_replace_elem_varg(cSTL* pSTL,
 ...
 */
extern void _basic_string_init_elem_auxiliary(cSTL* pSTL,basic_string_t* pt_basic_string, void* pv_elem);
