 ...
 */
extern stack_t* _create_stack(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_stack_auxiliary(cSTL* pSTL,stack_t* psk_stack, const char* s_typename);
 ...
 */
extern void _stack_destroy_auxiliary(cSTL* pSTL,stack_t* psk_stack);
 ...
 */
extern void _stack_push(cSTL* pSTL,stack_t* psk_stack, ...);
 ...
 *          in use, others are not in use.
 */
extern void _stack_push_varg(cSTL* pSTL,stack_t* psk_stack, va_list val_elemlist);
