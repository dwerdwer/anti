 ...
 */
#define create_hash_set(pSTL,...) _create_hash_set(pSTL,#__VA_ARGS__)
 ...
 */
#define hash_set_find(pSTL,cphset_set, elem) _hash_set_find((pSTL),(cphset_set), (elem))
 ...
 *          the type of specific element and cphset_set must be same, otherwise the behavior is undefined.
 */
#define hash_set_count(pSTL,cphset_set, elem) _hash_set_count((pSTL),(cphset_set), (elem))
 ...
 *          the type of specific element and cphset_set must be same, otherwise the behavior is undefined.
 */
#define hash_set_equal_range(pSTL,cphset_set, elem) _hash_set_equal_range((pSTL),(cphset_set), (elem))
 ...
 *          the type of specific element and cphset_set must be same, otherwise the behavior is undefined.
 */
#define hash_set_insert(pSTL,phset_set, elem) _hash_set_insert((pSTL),(phset_set), (elem))
 ...
 * @remarks if phset_set == NULL then the behavior is undefined. cphset_set must be initialized, otherwise the behavior is undefined. 
 */
#define hash_set_erase(pSTL,phset_set, elem) _hash_set_erase((pSTL),(phset_set), (elem))
 ...
 */
extern void hash_set_init(cSTL* pSTL,hash_set_t* phset_set);
 ...
 */
extern void hash_set_init_ex(cSTL* pSTL,hash_set_t* phset_set, size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void hash_set_init_copy(cSTL* pSTL,hash_set_t* phset_dest, const hash_set_t* cphset_src);
 ...
 *          undefined.
 */
extern void hash_set_init_copy_range(cSTL* pSTL,hash_set_t* phset_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void hash_set_init_copy_array(cSTL* pSTL,hash_set_t* phset_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_set_init_copy_range_ex(cSTL* pSTL,hash_set_t* phset_set, iterator_t it_begin, iterator_t it_end,
 ...
 */
extern void hash_set_init_copy_array_ex(cSTL* pSTL,hash_set_t* phset_set, const void* cpv_array, size_t t_count,
    size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void hash_set_destroy(cSTL* pSTL,hash_set_t* phset_set);
 ...
 */
extern void hash_set_assign(cSTL* pSTL,hash_set_t* phset_dest, const hash_set_t* cphset_src);
 ...
 */
extern void hash_set_swap(cSTL* pSTL,hash_set_t* phset_first, hash_set_t* phset_second);
 ...
 *          is undefined.
 */
extern void hash_set_resize(cSTL* pSTL,hash_set_t* phset_set, size_t t_resize);
 ...
 */
extern bool_t hash_set_equal(cSTL* pSTL,const hash_set_t* cphset_first, const hash_set_t* cphset_second);
 ...
 */
extern bool_t hash_set_not_equal(cSTL* pSTL,const hash_set_t* cphset_first, const hash_set_t* cphset_second);
 ...
 */
extern bool_t hash_set_less(cSTL* pSTL,const hash_set_t* cphset_first, const hash_set_t* cphset_second);
 ...
 */
extern bool_t hash_set_less_equal(cSTL* pSTL,const hash_set_t* cphset_first, const hash_set_t* cphset_second);
 ...
 *          undefined. if cphset_first == cphset_second, then return false.
 */
extern bool_t hash_set_greater(cSTL* pSTL,const hash_set_t* cphset_first, const hash_set_t* cphset_second);
 ...
 *          undefined. if cphset_first == cphset_second, then return true.
 */
extern bool_t hash_set_greater_equal(cSTL* pSTL,const hash_set_t* cphset_first, const hash_set_t* cphset_second);
 ...
 */
extern void hash_set_insert_range(cSTL* pSTL,hash_set_t* phset_set, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void hash_set_insert_array(cSTL* pSTL,hash_set_t* phset_set, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_set_erase_pos(cSTL* pSTL,hash_set_t* phset_set, hash_set_iterator_t it_pos);
 ...
 */
extern void hash_set_erase_range(cSTL* pSTL,hash_set_t* phset_set, hash_set_iterator_t it_begin, hash_set_iterator_t it_end);
 ...
 */
extern void hash_set_clear(cSTL* pSTL,hash_set_t* phset_set);
