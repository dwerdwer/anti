 ...
 * @remarks void
 */
extern string_t* create_string(cSTL* pSTL);
 ...
 */
extern void string_init(cSTL* pSTL,string_t* pstr_string);
 ...
 */
extern void string_init_cstr(cSTL* pSTL,string_t* pstr_string, const char* s_cstr);
 ...
 */
extern void string_init_copy(cSTL* pSTL,string_t* pstr_dest, const string_t* cpstr_src);
 ...
 */
extern void string_init_copy_substring(cSTL* pSTL,string_t* pstr_dest, const string_t* cpstr_src, size_t t_pos, size_t t_len);
 ...
 */
extern void string_init_copy_range(cSTL* pSTL,string_t* pstr_string, string_iterator_t it_begin, string_iterator_t it_end);
 ...
 */
extern void string_destroy(cSTL* pSTL,string_t* pstr_string);
 ...
 */
extern size_t string_copy(cSTL* pSTL,const string_t* cpstr_string, char* s_buffer, size_t t_len, size_t t_pos);
 ...
 */
extern bool_t string_equal(cSTL* pSTL,const string_t* cpstr_first, const string_t* cpstr_second);
 ...
 */
extern bool_t string_not_equal(cSTL* pSTL,const string_t* cpstr_first, const string_t* cpstr_second);
 ...
 *          initialized, otherwise the behavior is undefined. if cpstr_first == cpstr_second, then return false.
 */
extern bool_t string_less(cSTL* pSTL,const string_t* cpstr_first, const string_t* cpstr_second);
 ...
 *          initialized, otherwise the behavior is undefined. if cpstr_first == cpstr_second, then return true.
 */
extern bool_t string_less_equal(cSTL* pSTL,const string_t* cpstr_first, const string_t* cpstr_second);
 ...
 *          initialized, otherwise the behavior is undefined. if cpstr_first == cpstr_second, then return false.
 */
extern bool_t string_greater(cSTL* pSTL,const string_t* cpstr_first, const string_t* cpstr_second);
 ...
 *          initialized, otherwise the behavior is undefined. if cpstr_first == cpstr_second, then return true.
 */
extern bool_t string_greater_equal(cSTL* pSTL,const string_t* cpstr_first, const string_t* cpstr_second);
 ...
 */
extern bool_t string_equal_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr);
 ...
 *          initialized, otherwise the behavior is undefined.
 */
extern bool_t string_not_equal_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr);
 ...
 *          initialized, otherwise the behavior is undefined.
 */
extern bool_t string_less_equal_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr);
 ...
 *          initialized, otherwise the behavior is undefined.
 */
extern bool_t string_greater_equal_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr);
 ...
 */
extern int string_compare(cSTL* pSTL,const string_t* cpstr_first, const string_t* cpstr_second);
 ...
 *          is in use.
 */
extern int string_compare_substring_string(cSTL* pSTL,
 ...
 */
extern int string_compare_substring_substring(cSTL* pSTL,
 ...
 *          initialized, otherwise the behavior is undefined.
 */
extern int string_compare_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr);
 ...
 *          is in use.
 */
extern int string_compare_substring_cstr(cSTL* pSTL,
 ...
 */
extern int string_compare_substring_subcstr(cSTL* pSTL,
 ...
 */
extern string_t* string_substr(cSTL* pSTL,const string_t* cpstr_string, size_t t_pos, size_t t_len);
 ...
 */
extern void string_connect(cSTL* pSTL,string_t* pstr_string, const string_t* cpstr_src);
 ...
 *          initialized, otherwise the behavior is undefined.
 */
extern void string_connect_cstr(cSTL* pSTL,string_t* pstr_string, const char* s_cstr);
 ...
 */
extern void string_connect_char(cSTL* pSTL,string_t* pstr_string, char c_char);
 ...
 */
extern size_t string_find(cSTL* pSTL,const string_t* cpstr_string, const string_t* cpstr_find, size_t t_pos);
 ...
 */
extern size_t string_find_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos);
 ...
 *          NPOS.
 */
extern size_t string_find_char(cSTL* pSTL,const string_t* cpstr_string, char c_char, size_t t_pos);
 ...
 */
extern size_t string_rfind(cSTL* pSTL,const string_t* cpstr_string, const string_t* cpstr_find, size_t t_pos);
 ...
 */
extern size_t string_rfind_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos);
 ...
 */
extern size_t string_rfind_char(cSTL* pSTL,const string_t* cpstr_string, char c_char, size_t t_pos);
 ...
 *          the behavior is undefined. if cpstr_find is empty, then return t_pos.
 */
extern size_t string_find_first_of(cSTL* pSTL,const string_t* cpstr_string, const string_t* cpstr_find, size_t t_pos);
 ...
 *          behavior is undefined. if s_cstr is empty, then return t_pos.
 */
extern size_t string_find_first_of_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos);
 ...
 *          the length of character string, then use all character string.
 */
extern size_t string_find_first_of_subcstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos, size_t t_len);
 ...
 *          NPOS.
 */
extern size_t string_find_first_of_char(cSTL* pSTL,const string_t* cpstr_string, char c_char, size_t t_pos);
 ...
 *          the behavior is undefined. if cpstr_find is empty, then return t_pos.
 */
extern size_t string_find_first_not_of(cSTL* pSTL,const string_t* cpstr_string, const string_t* cpstr_find, size_t t_pos);
 ...
 *          behavior is undefined. if s_cstr is empty, then return t_pos.
 */
extern size_t string_find_first_not_of_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos);
 ...
 *          NPOS.
 */
extern size_t string_find_first_not_of_char(cSTL* pSTL,const string_t* cpstr_string, char c_char, size_t t_pos);
 ...
 *          from the last character. if cpstr_find is empty, then return t_pos;
 */
extern size_t string_find_last_of(cSTL* pSTL,const string_t* cpstr_string, const string_t* cpstr_find, size_t t_pos);
 ...
 *          from the last character. if s_cstr is empty, then return t_pos;
 */
extern size_t string_find_last_of_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos);
 ...
 *          the length of character string, then use all character string.
 */
extern size_t string_find_last_of_subcstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos, size_t t_len);
 ...
 *          from the last character. if cpstr_find is empty, then return t_pos;
 */
extern size_t string_find_last_not_of(cSTL* pSTL,const string_t* cpstr_string, const string_t* cpstr_find, size_t t_pos);
 ...
 *          from the last character. if s_cstr is empty, then return t_pos;
 */
extern size_t string_find_last_not_of_cstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos);
 ...
 *          the length of character string, then use all character string.
 */
extern size_t string_find_last_not_of_subcstr(cSTL* pSTL,const string_t* cpstr_string, const char* s_cstr, size_t t_pos, size_t t_len);
 ...
 *          behavior is undefined.
 */
extern void string_clear(cSTL* pSTL,string_t* pstr_string);
 ...
 */
extern void string_swap(cSTL* pSTL,string_t* pstr_first, string_t* pstr_second);
 ...
 */
extern void string_reserve(cSTL* pSTL,string_t* pstr_string, size_t t_reservesize);
 ...
 */
extern void string_resize(cSTL* pSTL,string_t* pstr_string, size_t t_resize, char c_char);
 ...
 * @remarks if pstr_string == NULL or uninitialized, then the bahavior is undefine.
 */
extern void string_push_back(cSTL* pSTL,string_t* pstr_string, char c_char);
 ...
 */
extern void string_assign(cSTL* pSTL,string_t* pstr_dest, const string_t* cpstr_src);
 ...
 *          string.
 */
extern void string_assign_substring(cSTL* pSTL,string_t* pstr_dest, const string_t* cpstr_src, size_t t_pos, size_t t_len);
 ...
 *          otherwise the behavior is undefined.
 */
extern void string_assign_cstr(cSTL* pSTL,string_t* pstr_string, const char* s_cstr);
 ...
 */
extern void string_assign_subcstr(cSTL* pSTL,string_t* pstr_string, const char* s_cstr, size_t t_len);
 ...
 */
extern void string_assign_char(cSTL* pSTL,string_t* pstr_string, size_t t_count, char c_char);
 ...
 */
extern void string_assign_range(cSTL* pSTL,string_t* pstr_string, string_iterator_t it_begin, string_iterator_t it_end);
 ...
 *          initialized, otherwise the behavior is undefined. 
 */
extern void string_append(cSTL* pSTL,string_t* pstr_dest, const string_t* cpstr_src);
 ...
 *          string.
 */
extern void string_append_substring(cSTL* pSTL,string_t* pstr_dest, const string_t* cpstr_src, size_t t_pos, size_t t_len);
 ...
 *          otherwise the behavior is undefined.
 */
extern void string_append_cstr(cSTL* pSTL,string_t* pstr_string, const char* s_cstr);
 ...
 */
extern void string_append_subcstr(cSTL* pSTL,string_t* pstr_string, const char* s_cstr, size_t t_len);
 ...
 * @remarks if pstr_string == NULL or string is uninitialized, then the behavior is undefined.
 */
extern void string_append_char(cSTL* pSTL,string_t* pstr_string, size_t t_count, char c_char);
 ...
 *          behavior is undefined. if [it_begin, it_end) belong to the destination string, the behavior is undefined.
 */
extern void string_append_range(cSTL* pSTL,string_t* pstr_string, string_iterator_t it_begin, string_iterator_t it_end);
 ...
 */
extern string_iterator_t string_insert(cSTL* pSTL,string_t* pstr_string, string_iterator_t it_pos, char c_char);
 ...
 *          invalid iterator of string container, otherwise the behavior is undefined.
 */
extern string_iterator_t string_insert_n(cSTL* pSTL,string_t* pstr_string, string_iterator_t it_pos, size_t t_count, char c_char);
 ...
 */
extern void string_insert_string(cSTL* pSTL,string_t* pstr_string, size_t t_pos, const string_t* cpstr_insert);
 ...
 */
extern void string_insert_substring(cSTL* pSTL,
 ...
 *          behavior is undefined.
 */
extern void string_insert_cstr(cSTL* pSTL,string_t* pstr_string, size_t t_pos, const char* s_cstr);
 ...
 *          string.
 */
extern void string_insert_subcstr(cSTL* pSTL,string_t* pstr_string, size_t t_pos, const char* s_cstr, size_t t_len);
 ...
 */
extern void string_insert_char(cSTL* pSTL,string_t* pstr_string, size_t t_pos, size_t t_count, char c_char);
 ...
 */
extern void string_insert_range(cSTL* pSTL,
 ...
 */
extern string_iterator_t string_erase(cSTL* pSTL,string_t* pstr_string, string_iterator_t it_pos);
 ...
 *          the behavior is undefined. [it_begin, it_end) must be valid range, otherwise the behavior is undefine.
 */
extern string_iterator_t string_erase_range(cSTL* pSTL,
 ...
 */
extern void string_erase_substring(cSTL* pSTL,string_t* pstr_string, size_t t_pos, size_t t_len);
 ...
 */
extern void string_replace(cSTL* pSTL,string_t* pstr_string, size_t t_pos, size_t t_len, const string_t* cpstr_replace);
 ...
 */
extern void string_replace_substring(cSTL* pSTL,
 ...
 */
extern void string_replace_cstr(cSTL* pSTL,string_t* pstr_string, size_t t_pos, size_t t_len, const char* s_cstr);
 ...
 *          then use all s_cstr.
 */
extern void string_replace_subcstr(cSTL* pSTL,string_t* pstr_string, size_t t_pos, size_t t_len, const char* s_cstr, size_t t_length);
 ...
 */
extern void string_range_replace(cSTL* pSTL,
 ...
 *          cpstr_replace that started from t_position. if pstr_string == cpstr_replace, then the behavior is undefined.
 */
extern void string_range_replace_substring(cSTL* pSTL,
    string_t* pstr_string, string_iterator_t it_begin, string_iterator_t it_end,
 ...
 *          otherwise the behavior is undefined.
 */
extern void string_range_replace_cstr(cSTL* pSTL,
 ...
 *          then use all s_cstr.
 */
extern void string_range_replace_subcstr(cSTL* pSTL,
 ...
 *          otherwise the behavior is undefined.
 */
extern void string_range_replace_char(cSTL* pSTL,
 ...
 *          behavior is undefined.
 */
extern void string_replace_range(cSTL* pSTL,
    string_t* pstr_string, string_iterator_t it_begin, string_iterator_t it_end,
