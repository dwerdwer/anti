 ...
 */
extern void _list_iterator_get_value(cSTL* pSTL,list_iterator_t it_iter, void* pv_value);
 ...
 *          behavior is undefined.
 */
extern void _list_iterator_set_value(cSTL* pSTL,list_iterator_t it_iter, const void* cpv_value);
