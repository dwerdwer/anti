...
/* count */
#define algo_count(pSTL,t_first, t_last, elem)\
    _algo_count((pSTL),(t_first), (t_last), (elem))
/* find */
#define algo_find(pSTL,t_first, t_last, elem)\
    _algo_find((pSTL),(t_first), (t_last), (elem))
/* search */
...
/* lower bound */
#define algo_lower_bound(pSTL,t_first, t_last, elem)\
    _algo_lower_bound((pSTL),(t_first), (t_last), (elem))
#define algo_lower_bound_if(t_first, t_last, elem, t_binary_op)\
    _algo_lower_bound_if((t_first), (t_last), (t_binary_op), (elem))
/* upper bound */
#define algo_upper_bound(pSTL,t_first, t_last, elem)\
    _algo_upper_bound((pSTL),(t_first), (t_last), (elem))
 ...
 * set algorithm.
 */
extern output_iterator_t algo_set_union(cSTL* pSTL,
...
extern output_iterator_t algo_set_union_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result,
    binary_function_t t_binary_op);
extern output_iterator_t algo_set_intersection(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result);
extern output_iterator_t algo_set_intersection_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result,
    binary_function_t t_binary_op);
extern output_iterator_t algo_set_difference(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result);
extern output_iterator_t algo_set_difference_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result,
    binary_function_t t_binary_op);
extern output_iterator_t algo_set_symmetric_difference(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result);
extern output_iterator_t algo_set_symmetric_difference_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result,
    binary_function_t t_binary_op);
 ...
 */
extern forward_iterator_t algo_adjacent_find(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last);
extern forward_iterator_t algo_adjacent_find_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op);
 ...
 * count algorithm.
 */
extern size_t algo_count_if(cSTL* pSTL,
 ...
 */
extern input_iterator_t algo_find_if(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
    unary_function_t t_unary_op);
extern input_iterator_t algo_find_first_of(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2);
extern input_iterator_t algo_find_first_of_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2,
    binary_function_t t_binary_op);
 ...
 * search algorithm.
 */
extern forward_iterator_t algo_search(cSTL* pSTL,
    forward_iterator_t t_first1, forward_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2);
extern forward_iterator_t algo_search_if(cSTL* pSTL,
    forward_iterator_t t_first1, forward_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2,
    binary_function_t t_binary_op);
 ...
 */
extern forward_iterator_t algo_search_end(cSTL* pSTL,
    forward_iterator_t t_first1, forward_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2);
extern forward_iterator_t algo_search_end_if(cSTL* pSTL,
    forward_iterator_t t_first1, forward_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2,
    binary_function_t t_binary_op);
extern forward_iterator_t algo_find_end(cSTL* pSTL,
    forward_iterator_t t_first1, forward_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2);
extern forward_iterator_t algo_find_end_if(cSTL* pSTL,
    forward_iterator_t t_first1, forward_iterator_t t_last1,
    forward_iterator_t t_first2, forward_iterator_t t_last2,
    binary_function_t t_binary_op);
 ...
 * includes algorithm.
 */
extern bool_t algo_includes(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2);
extern bool_t algo_includes_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    binary_function_t t_binary_op);
 ...
 */
extern forward_iterator_t algo_max_element(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last);
extern forward_iterator_t algo_max_element_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op);
extern forward_iterator_t algo_min_element(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last);
extern forward_iterator_t algo_min_element_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op);
 ...
 * merge algorithm.
 */
extern output_iterator_t algo_merge(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
    output_iterator_t t_result);
extern output_iterator_t algo_merge_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    input_iterator_t t_first2, input_iterator_t t_last2,
 ...
 * partition algorithm.
 */
extern forward_iterator_t algo_partition(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    unary_function_t t_unary_op);
extern forward_iterator_t algo_stable_partition(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    unary_function_t t_unary_op);
 ...
 * remove algorithm.
 */
extern forward_iterator_t algo_remove_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last, unary_function_t t_unary_op);
extern output_iterator_t algo_remove_copy_if(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
 ...
 * reverse algorithm.
 */
extern void algo_reverse(cSTL* pSTL,
    bidirectional_iterator_t t_first, bidirectional_iterator_t t_last);
extern output_iterator_t algo_reverse_copy(cSTL* pSTL,
    bidirectional_iterator_t t_first, bidirectional_iterator_t t_last,
    output_iterator_t t_result);
 ...
 * rotate algorithm.
 */
extern forward_iterator_t algo_rotate(cSTL* pSTL,
    forward_iterator_t t_first,
    forward_iterator_t t_middle,
    forward_iterator_t t_last);
extern output_iterator_t algo_rotate_copy(cSTL* pSTL,
    forward_iterator_t t_first,
    forward_iterator_t t_middle,
    forward_iterator_t t_last,
    output_iterator_t t_result);
 ...
 */
extern forward_iterator_t algo_swap_ranges(cSTL* pSTL,
    forward_iterator_t t_first1, forward_iterator_t t_last1,
 ...
 * unique algorithm.
 */
extern forward_iterator_t algo_unique(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last);
extern forward_iterator_t algo_unique_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op);
extern output_iterator_t algo_unique_copy(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
    output_iterator_t t_result);
extern output_iterator_t algo_unique_copy_if(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
    output_iterator_t t_result, binary_function_t t_binary_op);
 ...
 */
extern bool_t algo_next_permutation(cSTL* pSTL,
    bidirectional_iterator_t t_first, bidirectional_iterator_t t_last);
extern bool_t algo_next_permutation_if(cSTL* pSTL,
    bidirectional_iterator_t t_first, bidirectional_iterator_t t_last,
    binary_function_t t_binary_op);
extern bool_t algo_prev_permutation(cSTL* pSTL,
    bidirectional_iterator_t t_first, bidirectional_iterator_t t_last);
extern bool_t algo_prev_permutation_if(cSTL* pSTL,
    bidirectional_iterator_t t_first, bidirectional_iterator_t t_last,
    binary_function_t t_binary_op);
 ...
 */
extern void algo_partial_sort(cSTL* pSTL,
    random_access_iterator_t t_first,
    random_access_iterator_t t_middle,
    random_access_iterator_t t_last);
extern void algo_partial_sort_if(cSTL* pSTL,
    random_access_iterator_t t_first,
    random_access_iterator_t t_middle,
    random_access_iterator_t t_last,
    binary_function_t t_binary_op);
extern random_access_iterator_t algo_partial_sort_copy(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    random_access_iterator_t t_first2, random_access_iterator_t t_last2);
extern random_access_iterator_t algo_partial_sort_copy_if(cSTL* pSTL,
    input_iterator_t t_first1, input_iterator_t t_last1,
    random_access_iterator_t t_first2, random_access_iterator_t t_last2,
    binary_function_t t_binary_op);
 ...
 * sort algorithm.
 */
extern void algo_sort(cSTL* pSTL,
    random_access_iterator_t t_first, random_access_iterator_t t_last);
extern void algo_sort_if(cSTL* pSTL,
    random_access_iterator_t t_first, random_access_iterator_t t_last,
    binary_function_t t_binary_op);
 ...
 */
extern void algo_nth_element(cSTL* pSTL,
    random_access_iterator_t t_first,
    random_access_iterator_t t_nth,
    random_access_iterator_t t_last);
extern void algo_nth_element_if(cSTL* pSTL,
    random_access_iterator_t t_first,
    random_access_iterator_t t_nth,
    random_access_iterator_t t_last,
    binary_function_t t_binary_op);
...
extern bool_t algo_is_sorted(
    forward_iterator_t t_first, forward_iterator_t t_last);
extern bool_t algo_is_sorted_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op);
 ...
 */
extern void algo_stable_sort(cSTL* pSTL,
    random_access_iterator_t t_first, random_access_iterator_t t_last);
extern void algo_stable_sort_if(cSTL* pSTL,
    random_access_iterator_t t_first, random_access_iterator_t t_last,
    binary_function_t t_binary_op);
