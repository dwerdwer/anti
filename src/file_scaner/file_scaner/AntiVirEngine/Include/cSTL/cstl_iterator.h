 ...
 */
extern void iterator_get_value(cSTL* pSTL,iterator_t it_iter, void* pv_value);
 ...
 */
extern void iterator_set_value(cSTL* pSTL,iterator_t it_iter, const void* cpv_value);
