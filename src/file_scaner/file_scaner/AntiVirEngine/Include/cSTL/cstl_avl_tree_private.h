 ...
 */
extern bool_t _create_avl_tree_auxiliary(cSTL* pSTL,_avl_tree_t* pt_avl_tree, const char* s_typename);
 ...
 */
extern void _avl_tree_destroy_auxiliary(cSTL* pSTL,_avl_tree_t* pt_avl_tree);
