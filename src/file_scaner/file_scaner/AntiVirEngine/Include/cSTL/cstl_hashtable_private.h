 ...
 */
extern bool_t _create_hashtable_auxiliary(cSTL* pSTL,_hashtable_t* pt_hashtable, const char* s_typename);
 ...
 */
extern void _hashtable_destroy_auxiliary(cSTL* pSTL,_hashtable_t* pt_hashtable);
