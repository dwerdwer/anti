 ...
 */
#define create_list(pSTL,...) _create_list(pSTL,#__VA_ARGS__)
 ...
 */
#define list_init_elem(pSTL,plist_list, t_count, elem) _list_init_elem((pSTL),(plist_list), (t_count), (elem))
 ...
 */
#define list_assign_elem(pSTL,plist_list, t_count, elem) _list_assign_elem((pSTL),(plist_list), (t_count), (elem))
 ...
 *          element and list element type must be same, otherwise the behavior is undefined.
 */
#define list_push_back(pSTL,plist_list, elem) _list_push_back((pSTL),(plist_list), (elem))
 ...
 *          element and list element type must be same, otherwise the behavior is undefined.
 */
#define list_push_front(pSTL,plist_list, elem) _list_push_front((pSTL),(plist_list), (elem))
 ...
 *          element.
 */
#define list_resize_elem(pSTL,plist_list, t_count, elem) _list_resize_elem((pSTL),(plist_list), (t_count), (elem))
 ...
 */
#define list_remove(pSTL,plist_list, elem) _list_remove((pSTL),(plist_list), (elem))
 ...
 */
#define list_insert(pSTL,plist_list, it_pos, elem) _list_insert_n((pSTL),(plist_list), (it_pos), 1, (elem))
 ...
 *          behavior is undefined.
 */
#define list_insert_n(pSTL,plist_list, it_pos, t_count, elem) _list_insert_n((pSTL),(plist_list), (it_pos), (t_count), (elem))
 ...
 */
extern void list_init(cSTL* pSTL,list_t* plist_list);
 ...
 *          the behavior is undefine.
 */
extern void list_init_n(cSTL* pSTL,list_t* plist_list, size_t t_count);
 ...
 */
extern void list_destroy(cSTL* pSTL,list_t* plist_list);
 ...
 */
extern void list_init_copy(cSTL* pSTL,list_t* plist_dest, const list_t* cplist_src);
 ...
 */
extern void list_init_copy_range(cSTL* pSTL,list_t* plist_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern bool_t list_equal(cSTL* pSTL,const list_t* cplist_first, const list_t* cplist_second);
 ...
 */
extern bool_t list_not_equal(cSTL* pSTL,const list_t* cplist_first, const list_t* cplist_second);
 ...
 */
extern bool_t list_less(cSTL* pSTL,const list_t* cplist_first, const list_t* cplist_second);
 ...
 */
extern bool_t list_less_equal(cSTL* pSTL,const list_t* cpt_listfirst, const list_t* cpt_listsecond);
 ...
 *          undefined. if cplist_first == cplist_second, then return false.
 */
extern bool_t list_greater(cSTL* pSTL,const list_t* cplist_first, const list_t* cplist_second);
 ...
 *          undefined. if cplist_first == cplist_second, then return true.
 */
extern bool_t list_greater_equal(cSTL* pSTL,const list_t* cplist_first, const list_t* cplist_second);
 ...
 */
extern void list_assign(cSTL* pSTL,list_t* plist_dest, const list_t* cplist_src);
 ...
 */
extern void list_assign_range(cSTL* pSTL,list_t* plist_list, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void list_swap(cSTL* pSTL,list_t* pt_listfirst, list_t* pt_listsecond);
 ...
 *          is undefined.
 */
extern list_iterator_t _list_end(const list_t* cplist_list);
/* private */
 ...
 */
extern void list_insert_array(cSTL* pSTL,list_t* plist_list, list_iterator_t it_pos, const void* cpv_array, size_t t_count);
 ...
 */
extern void list_pop_back(cSTL* pSTL,list_t* plist_list);
 ...
 */
extern list_iterator_t list_erase(cSTL* pSTL,list_t* plist_list, list_iterator_t it_pos);
 ...
 *          behavior is undefined.
 */
extern list_iterator_t list_erase_range(cSTL* pSTL,list_t* plist_list, list_iterator_t it_begin, list_iterator_t it_end);
 ...
 */
extern void list_resize(cSTL* pSTL,list_t* plist_list, size_t t_resize);
 ...
 *          is undefined.
 */
extern void list_clear(cSTL* pSTL,list_t* pt_list);
 ...
 */
extern void list_unique_if(cSTL* pSTL,list_t* plist_list, binary_function_t bfun_op);
 ...
 */
extern void list_splice(cSTL* pSTL,list_t* plist_list, list_iterator_t it_pos, list_t* plist_src);
 ...
 */
extern void list_splice_pos(cSTL* pSTL,list_t* plist_list, list_iterator_t it_pos, list_t* plist_src, list_iterator_t it_src);
 ...
 *          undefined.
 */
extern void list_sort(cSTL* pSTL,list_t* plist_list);
 ...
 */
extern void list_sort_if(cSTL* pSTL,list_t* plist_list, binary_function_t bfun_op);
 ...
 */
extern void list_merge(cSTL* pSTL,list_t* plist_dest, list_t* plist_src);
 ...
 */
extern void list_merge_if(cSTL* pSTL,list_t* plist_dest, list_t* plist_src, binary_function_t bfun_op);
 ...
 *          undefined.
 */
extern void list_reverse(cSTL* pSTL,list_t* plist_list);
