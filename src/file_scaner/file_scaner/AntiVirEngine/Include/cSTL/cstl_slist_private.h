 ...
 */
extern slist_t* _create_slist(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_slist_auxiliary(cSTL* pSTL,slist_t* pslist_slist, const char* s_typename);
 ...
 */
extern void _slist_init_elem(cSTL* pSTL,slist_t* pslist_slist, size_t t_count, ...);
 ...
 *          not in use. slist container must be created by create_slist, otherwise the behavior is undefined.
 */
extern void _slist_init_elem_varg(cSTL* pSTL,slist_t* pslist_slist, size_t t_count, va_list val_elemlist);
 ...
 */
extern void _slist_destroy_auxiliary(cSTL* pSTL,slist_t* pslist_slist);
 ...
 */
extern void _slist_assign_elem(cSTL* pSTL,slist_t* pslist_slist, size_t t_count, ...);
 ...
 *          in use, others are not in use.
 */
extern void _slist_assign_elem_varg(cSTL* pSTL,slist_t* pslist_slist, size_t t_count, va_list val_elemlist);
 ...
 *          in use, others are not in use.
 */
extern void _slist_push_front(cSTL* pSTL,slist_t* pslist_slist, ...);
 ...
 *          in use, others are not in use.
 */
extern void _slist_push_front_varg(cSTL* pSTL,slist_t* pslist_slist, va_list val_elemlist);
 ...
 *          then does nothing.
 */
extern void _slist_remove(cSTL* pSTL,slist_t* pt_slist, ...);
 ...
 *          then does nothing.
 */
extern void _slist_remove_varg(cSTL* pSTL,slist_t* pt_slist, va_list val_elemlist);
 ...
 *          element.
 */
extern void _slist_resize_elem(cSTL* pSTL,slist_t* pslist_slist, size_t t_resize, ...);
 ...
 */
extern void _slist_resize_elem_varg(cSTL* pSTL,slist_t* pslist_slist, size_t t_resize, va_list val_elemlist);
 ...
 *          in use.
 */
extern void _slist_insert_after_n_varg(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos, size_t t_count, va_list val_elemlist);
 ...
 *          in use.
 */
extern slist_iterator_t _slist_insert_after(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos, ...);
 ...
 *          in use.
 */
extern void _slist_insert_after_n(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos, size_t t_count, ...);
 ...
 *          in use.
 */
extern slist_iterator_t _slist_insert(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos, ...);
 ...
 *          in use.
 */
extern void _slist_insert_n(cSTL* pSTL,slist_t* pslist_slist, slist_iterator_t it_pos, size_t t_count, ...);
 ...
 */
extern void _slist_init_elem_auxiliary(cSTL* pSTL,slist_t* pslist_slist, void* pv_value);
