 ...
 */
#define create_multimap(pSTL,...) _create_multimap(pSTL,#__VA_ARGS__)
 ...
 */
extern void multimap_init(cSTL* pSTL,multimap_t* pmmap_map);
 ...
 */
extern void multimap_init_copy_range_ex(cSTL* pSTL,
 ...
 *          is undefined. if t_compare == NULL, then use default compare function.
 */
extern void multimap_init_copy_array_ex(cSTL* pSTL,
 ...
 */
extern void multimap_destroy(cSTL* pSTL,multimap_t* pmmap_map);
 ...
 */
extern void multimap_assign(cSTL* pSTL,multimap_t* pmmap_dest, const multimap_t* cpmmap_src);
 ...
 */
extern void multimap_swap(cSTL* pSTL,multimap_t* pmmap_first, multimap_t* pmmap_second);
 ...
 */
extern void multimap_clear(cSTL* pSTL,multimap_t* pmmap_map);
 ...
 */
extern bool_t multimap_equal(cSTL* pSTL,const multimap_t* cpmmap_first, const multimap_t* cpmmap_second);
 ...
 */
extern bool_t multimap_not_equal(cSTL* pSTL,const multimap_t* cpmmap_first, const multimap_t* cpmmap_second);
 ...
 */
extern bool_t multimap_less(cSTL* pSTL,const multimap_t* cpmmap_first, const multimap_t* cpmmap_second);
 ...
 */
extern bool_t multimap_less_equal(cSTL* pSTL,const multimap_t* cpmmap_first, const multimap_t* cpmmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return false.
 */
extern bool_t multimap_greater(cSTL* pSTL,const multimap_t* cpmmap_first, const multimap_t* cpmmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return true.
 */
extern bool_t multimap_greater_equal(cSTL* pSTL,const multimap_t* cpmmap_first, const multimap_t* cpmmap_second);
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern multimap_iterator_t multimap_insert(cSTL* pSTL,multimap_t* pmmap_map, const pair_t* cppair_pair);
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern multimap_iterator_t multimap_insert_hint(cSTL* pSTL,multimap_t* pmmap_map, multimap_iterator_t it_hint, const pair_t* cppair_pair);
 ...
 */
extern void multimap_insert_range(cSTL* pSTL,multimap_t* pmmap_map, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void multimap_insert_array(cSTL* pSTL,multimap_t* pmmap_map, const void* cpv_array, size_t t_count);
 ...
 */
extern void multimap_erase_pos(cSTL* pSTL,multimap_t* pmmap_map, multimap_iterator_t it_pos);
 ...
 */
extern void multimap_erase_range(cSTL* pSTL,multimap_t* pmmap_map, multimap_iterator_t it_begin, multimap_iterator_t it_end);
