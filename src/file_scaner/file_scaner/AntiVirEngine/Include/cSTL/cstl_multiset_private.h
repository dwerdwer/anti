 ...
 */
extern multiset_t* _create_multiset(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_multiset_auxiliary(cSTL* pSTL,multiset_t* pmset_mset, const char* s_typename);
 ...
 */
extern void _multiset_destroy_auxiliary(cSTL* pSTL,multiset_t* pv_multiset);
 ...
 */
extern multiset_iterator_t _multiset_find(cSTL* pSTL,const multiset_t* cpmset_mset, ...);
 ...
 *          is undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_find_varg(cSTL* pSTL,const multiset_t* cpmset_mset, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern size_t _multiset_count(cSTL* pSTL,const multiset_t* cpmset_mset, ...);
 ...
 *          is undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern size_t _multiset_count_varg(cSTL* pSTL,const multiset_t* cpmset_mset, va_list val_elemlist);
 ...
 */
extern multiset_iterator_t _multiset_lower_bound(cSTL* pSTL,const multiset_t* cpmset_mset, ...);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_lower_bound_varg(cSTL* pSTL,const multiset_t* cpmset_mset, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_upper_bound(cSTL* pSTL,const multiset_t* cpmset_mset, ...);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_upper_bound_varg(cSTL* pSTL,const multiset_t* cpmset_mset, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern range_t _multiset_equal_range(cSTL* pSTL,const multiset_t* cpmset_mset, ...);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern range_t _multiset_equal_range_varg(cSTL* pSTL,const multiset_t* cpmset_mset, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _multiset_erase(cSTL* pSTL,multiset_t* pmset_mset, ...);
 ...
 *          undefined. 
 */
extern size_t _multiset_erase_varg(cSTL* pSTL,multiset_t* pmset_mset, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_insert(cSTL* pSTL,multiset_t* pmset_mset, ...);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_insert_varg(cSTL* pSTL,multiset_t* pmset_mset, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_insert_hint(cSTL* pSTL,multiset_t* pmset_mset, multiset_iterator_t it_hint, ...);
 ...
 *          undefined. the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
extern multiset_iterator_t _multiset_insert_hint_varg(cSTL* pSTL,multiset_t* pmset_mset, multiset_iterator_t it_hint, va_list val_elemlist);
 ...
 */
extern void _multiset_init_elem_auxiliary(cSTL* pSTL,multiset_t* pmset_mset, void* pv_value);
