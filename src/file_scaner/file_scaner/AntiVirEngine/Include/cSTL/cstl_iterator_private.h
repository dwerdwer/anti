 ...
 * @remarks iterator must be valid, otherwise behavior is undefined.
 */
extern void* _iterator_allocate_init_elem(cSTL* pSTL,iterator_t it_iter);
 ...
 */
extern void _iterator_deallocate_destroy_elem(cSTL* pSTL,iterator_t it_iter, void* pv_value);
