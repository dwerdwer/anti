 ...
 */
extern set_t* _create_set(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_set_auxiliary(cSTL* pSTL,set_t* pset_set, const char* s_typename);
 ...
 */
extern void _set_destroy_auxiliary(cSTL* pSTL,set_t* pset_set);
 ...
 */
extern set_iterator_t _set_find(cSTL* pSTL,const set_t* cpset_set, ...);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_find_varg(cSTL* pSTL,const set_t* cpset_set, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern size_t _set_count(cSTL* pSTL,const set_t* cpset_set, ...);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern size_t _set_count_varg(cSTL* pSTL,const set_t* cpset_set, va_list val_elemlist);
 ...
 */
extern set_iterator_t _set_lower_bound(cSTL* pSTL,const set_t* cpset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_lower_bound_varg(cSTL* pSTL,const set_t* cpset_set, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_upper_bound(cSTL* pSTL,const set_t* cpset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_upper_bound_varg(cSTL* pSTL,const set_t* cpset_set, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern range_t _set_equal_range(cSTL* pSTL,const set_t* cpset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern range_t _set_equal_range_varg(cSTL* pSTL,const set_t* cpset_set, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _set_erase(cSTL* pSTL,set_t* pset_set, ...);
 ...
 *          undefined. 
 */
extern size_t _set_erase_varg(cSTL* pSTL,set_t* pset_set, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_insert(cSTL* pSTL,set_t* pset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_insert_varg(cSTL* pSTL,set_t* pset_set, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_insert_hint(cSTL* pSTL,set_t* pset_set, set_iterator_t it_hint, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_insert_hint_varg(cSTL* pSTL,set_t* pset_set, set_iterator_t it_hint, va_list val_elemlist);
 ...
 */
extern void _set_init_elem_auxiliary(cSTL* pSTL,set_t* pset_set, void* pv_value);
