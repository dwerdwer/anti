 ...
 */
extern bool_t _create_rb_tree_auxiliary(cSTL* pSTL,_rb_tree_t* pt_rb_tree, const char* s_typename);
 ...
 */
extern void _rb_tree_destroy_auxiliary(cSTL* pSTL,_rb_tree_t* pt_rb_tree);
