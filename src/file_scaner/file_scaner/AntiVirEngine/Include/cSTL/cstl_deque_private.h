 ...
 */
extern deque_t* _create_deque(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_deque_auxiliary(cSTL* pSTL,deque_t* pdeq_deque, const char* s_typename);
 ...
 */
extern void _deque_init_elem(cSTL* pSTL,deque_t* pdeq_deque, size_t t_count, ...);
 ...
 *          not in use. deque container must be created by create_deque, otherwise the behavior is undefined.
 */
extern void _deque_init_elem_varg(cSTL* pSTL,deque_t* pdeq_deque, size_t t_count, va_list val_elemlist);
 ...
 */
extern void _deque_destroy_auxiliary(cSTL* pSTL,deque_t* pdeq_deque);
 ...
 */
extern void _deque_assign_elem(cSTL* pSTL,deque_t* pdeq_deque, size_t t_count, ...);
 ...
 *          in use, others are not in use.
 */
extern void _deque_assign_elem_varg(cSTL* pSTL,deque_t* pdeq_deque, size_t t_count, va_list val_elemlist);
 ...
 *          in use, others are not in use.
 */
extern void _deque_push_back(cSTL* pSTL,deque_t* pdeq_deque, ...);
 ...
 *          in use, others are not in use.
 */
extern void _deque_push_back_varg(cSTL* pSTL,deque_t* pdeq_deque, va_list val_elemlist);
 ...
 *          in use, others are not in use.
 */
extern void _deque_push_front(cSTL* pSTL,deque_t* pdeq_deque, ...);
 ...
 *          in use, others are not in use.
 */
extern void _deque_push_front_varg(cSTL* pSTL,deque_t* pdeq_deque, va_list val_elemlist);
 ...
 *          element.
 */
extern void _deque_resize_elem(cSTL* pSTL,deque_t* pdeq_deque, size_t t_resize, ...);
 ...
 */
extern void _deque_resize_elem_varg(cSTL* pSTL,deque_t* pdeq_deque, size_t t_resize, va_list val_elemlist);
 ...
 *          in use.
 */
extern deque_iterator_t _deque_insert_n(cSTL* pSTL,deque_t* pdeq_deque, deque_iterator_t it_pos, size_t t_count, ...);
 ...
 */
extern deque_iterator_t _deque_insert_n_varg(cSTL* pSTL,deque_t* pdeq_deque, deque_iterator_t it_pos, size_t t_count, va_list val_elemlist);
 ...
 */
extern void _deque_init_elem_auxiliary(cSTL* pSTL,deque_t* pdeq_deque, void* pv_value);
