 ...
 */
extern hash_multiset_t* _create_hash_multiset(cSTL* pSTL,const char* s_typename);
 ...
 */
extern void _hash_multiset_destroy_auxiliary(cSTL* pSTL,hash_multiset_t* phmset_set);
 ...
 */
extern hash_multiset_iterator_t _hash_multiset_find(cSTL* pSTL,const hash_multiset_t* cphmset_set, ...);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern hash_multiset_iterator_t _hash_multiset_find_varg(cSTL* pSTL,const hash_multiset_t* cphmset_set, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_multiset_count(cSTL* pSTL,const hash_multiset_t* cphmset_set, ...);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_multiset_count_varg(cSTL* pSTL,const hash_multiset_t* cphmset_set, va_list val_elemlist);
 ...
 */
extern range_t _hash_multiset_equal_range(cSTL* pSTL,const hash_multiset_t* cphmset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern range_t _hash_multiset_equal_range_varg(cSTL* pSTL,const hash_multiset_t* cphmset_set, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern hash_multiset_iterator_t _hash_multiset_insert(cSTL* pSTL,hash_multiset_t* phmset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern hash_multiset_iterator_t _hash_multiset_insert_varg(cSTL* pSTL,hash_multiset_t* phmset_set, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _hash_multiset_erase(cSTL* pSTL,hash_multiset_t* phmset_set, ...);
 ...
 *          undefined. 
 */
extern size_t _hash_multiset_erase_varg(cSTL* pSTL,hash_multiset_t* phmset_set, va_list val_elemlist);
 ...
 */
extern void _hash_multiset_init_elem_auxiliary(cSTL* pSTL,hash_multiset_t* phmset_set, void* pv_value);
