 ...
 */
extern void _avl_tree_init_copy(cSTL* pSTL,_avl_tree_t* pt_dest, const _avl_tree_t* cpt_src);
 ...
 *          undefined.
 */
extern void _avl_tree_init_copy_equal_range(cSTL* pSTL,_avl_tree_t* pt_dest, iterator_t it_begin, iterator_t it_end);
 ...
 *          undefined.
 */
extern void _avl_tree_init_copy_unique_range(cSTL* pSTL,_avl_tree_t* pt_dest, iterator_t it_begin, iterator_t it_end);
 ...
 *          the behavior is undefined. the type of array and pt_dest must be same, otherwise the behavior is undefined.
 */
extern void _avl_tree_init_copy_unique_array(cSTL* pSTL,_avl_tree_t* pt_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void _avl_tree_init_copy_equal_array_ex(cSTL* pSTL,_avl_tree_t* pt_dest, const void* cpv_array, size_t t_count, binary_function_t t_compare);
 ...
 *          undefined. if t_compare == NULL, then use default compare function.
 */
extern void _avl_tree_init_copy_unique_range_ex(cSTL* pSTL,_avl_tree_t* pt_dest, iterator_t it_begin, iterator_t it_end, binary_function_t t_compare);
 ...
 *          if t_compare == NULL, then use default compare function.
 */
extern void _avl_tree_init_copy_unique_array_ex(cSTL* pSTL,_avl_tree_t* pt_dest, const void* cpv_array, size_t t_count, binary_function_t t_compare);
 ...
 */
extern void _avl_tree_destroy(cSTL* pSTL,_avl_tree_t* pt_avl_tree);
 ...
 */
extern void _avl_tree_assign(cSTL* pSTL,_avl_tree_t* pt_dest, const _avl_tree_t* cpt_src);
 ...
 *          behavior is undefined.
 */
extern _avl_tree_iterator_t _avl_tree_find(cSTL* pSTL,const _avl_tree_t* cpt_avl_tree, const void* cpv_value);
 ...
 *          is undefined.
 */
extern void _avl_tree_clear(cSTL* pSTL,_avl_tree_t* pt_avl_tree);
 ...
 *          behavior is undefined.
 */
extern size_t _avl_tree_count(cSTL* pSTL,const _avl_tree_t* cpt_avl_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern _avl_tree_iterator_t _avl_tree_lower_bound(cSTL* pSTL,const _avl_tree_t* cpt_avl_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern _avl_tree_iterator_t _avl_tree_upper_bound(cSTL* pSTL,const _avl_tree_t* cpt_avl_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern range_t _avl_tree_equal_range(cSTL* pSTL,const _avl_tree_t* cpt_avl_tree, const void* cpv_value);
 ...
 */
extern bool_t _avl_tree_equal(cSTL* pSTL,const _avl_tree_t* cpt_first, const _avl_tree_t* cpt_second);
 ...
 */
extern bool_t _avl_tree_less_equal(cSTL* pSTL,const _avl_tree_t* cpt_first, const _avl_tree_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return false.
 */
extern bool_t _avl_tree_greater(cSTL* pSTL,const _avl_tree_t* cpt_first, const _avl_tree_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return true.
 */
extern bool_t _avl_tree_greater_equal(cSTL* pSTL,const _avl_tree_t* cpt_first, const _avl_tree_t* cpt_second);
 ...
 */
extern void _avl_tree_swap(cSTL* pSTL,_avl_tree_t* pt_first, _avl_tree_t* pt_second);
 ...
 *          behavior is undefined.
 */
extern _avl_tree_iterator_t _avl_tree_insert_unique(cSTL* pSTL,_avl_tree_t* pt_avl_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern _avl_tree_iterator_t _avl_tree_insert_equal(cSTL* pSTL,_avl_tree_t* pt_avl_tree, const void* cpv_value);
 ...
 */
extern void _avl_tree_insert_unique_range(cSTL* pSTL,_avl_tree_t* pt_avl_tree, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void _avl_tree_insert_unique_array(cSTL* pSTL,_avl_tree_t* pt_avl_tree, const void* cpv_array, size_t t_count);
 ...
 *          [it_begin, it_end) must be valid range, otherwise the behavior is undefine.
 */
extern void _avl_tree_insert_equal_range(cSTL* pSTL,_avl_tree_t* pt_avl_tree, iterator_t it_begin, iterator_t it_end);
 ...
 *          array must be valid array, otherwise the behavior is undefine.
 */
extern void _avl_tree_insert_equal_array(cSTL* pSTL,_avl_tree_t* pt_avl_tree, const void* cpv_array, size_t t_count);
 ...
 */
extern void _avl_tree_erase_pos(cSTL* pSTL,_avl_tree_t* pt_avl_tree, _avl_tree_iterator_t it_pos);
 ...
 */
extern void _avl_tree_erase_range(cSTL* pSTL,_avl_tree_t* pt_avl_tree, _avl_tree_iterator_t it_begin, _avl_tree_iterator_t it_end);
 ...
 */
extern size_t _avl_tree_erase(cSTL* pSTL,_avl_tree_t* pt_avl_tree, const void* cpv_value);
