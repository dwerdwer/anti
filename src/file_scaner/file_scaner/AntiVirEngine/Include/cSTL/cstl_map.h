 ...
 */
#define create_map(pSTL,...) _create_map(pSTL,#__VA_ARGS__)
 ...
 */
#define map_find(pSTL,cpmap_map, key_elem) _map_find((pSTL),(cpmap_map), (key_elem))
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
#define map_count(pSTL,cpmap_map, key_elem) _map_count((pSTL),(cpmap_map), (key_elem))
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
#define map_lower_bound(pSTL,cpmap_map, key_elem) _map_lower_bound((pSTL),(cpmap_map), (key_elem))
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
#define map_upper_bound(pSTL,cpmap_map, key_elem) _map_upper_bound((pSTL),(cpmap_map), (key_elem))
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
#define map_equal_range(pSTL,cpmap_map, key_elem) _map_equal_range((pSTL),(cpmap_map), (key_elem))
 ...
 *          undefined. 
 */
#define map_at(pSTL,pmap_map, key_elem) _map_at((pSTL),(pmap_map), (key_elem))
 ...
 */
#define map_erase(pSTL,pmap_map, key_elem) _map_erase((pSTL),(pmap_map), (key_elem))
 ...
 */
extern void _map_init(cSTL* pSTL,map_t* pmap_map);
 ...
 */
extern void map_init_copy_range_ex(cSTL* pSTL,
 ...
 *          is undefined. if t_compare == NULL, then use default compare function.
 */
extern void map_init_copy_array_ex(cSTL* pSTL,
 ...
 */
extern void map_destroy(cSTL* pSTL,map_t* pmap_map);
 ...
 */
extern void map_assign(cSTL* pSTL,map_t* pmap_dest, const map_t* cpmap_src);
 ...
 */
extern void _map_swap(cSTL* pSTL,map_t* pmap_first, map_t* pmap_second);
 ...
 *          is undefined.
 */
extern size_t _map_size(const map_t* cpmap_map);
 ...
 * @remarks if cpmap_map == NULL, the behavior is undefined. cpmap_map must be initialized, otherwise the behavior is undefined.
 */
extern map_iterator_t _map_end(const map_t* cpmap_map);
/* private */
extern map_reverse_iterator_t map_rbegin(const map_t* cpmap_map);
extern map_reverse_iterator_t _map_rend(const map_t* cpmap_map);
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern map_iterator_t map_insert(cSTL* pSTL,map_t* pmap_map, const pair_t* cppair_pair);
 ...
 *          the type of specific element and cpmap_map must be same, otherwise the behavior is undefined.
 */
extern map_iterator_t map_insert_hint(cSTL* pSTL,map_t* pmap_map, map_iterator_t it_hint, const pair_t* cppair_pair);
 ...
 */
extern void map_insert_range(cSTL* pSTL,map_t* pmap_map, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void map_insert_array(cSTL* pSTL,map_t* pmap_map, const void* cpv_array, size_t t_count);
 ...
 */
extern void map_erase_pos(cSTL* pSTL,map_t* pmap_map, map_iterator_t t_pos);
 ...
 */
extern void map_erase_range(cSTL* pSTL,map_t* pmap_map, map_iterator_t it_begin, map_iterator_t it_end);
 ...
 */
extern void map_clear(cSTL* pSTL,map_t* pmap_map);
 ...
 */
extern bool_t map_equal(cSTL* pSTL,const map_t* cpmap_first, const map_t* cpmap_second);
 ...
 */
extern bool_t map_not_equal(cSTL* pSTL,const map_t* cpmap_first, const map_t* cpmap_second);
 ...
 */
extern bool_t _map_less(cSTL* pSTL,const map_t* cpmap_first, const map_t* cpmap_second);
 ...
 */
extern bool_t map_less_equal(cSTL* pSTL,const map_t* cpmap_first, const map_t* cpmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return false.
 */
extern bool_t map_greater(cSTL* pSTL,const map_t* cpmap_first, const map_t* cpmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return true.
 */
extern bool_t map_greater_equal(cSTL* pSTL,const map_t* cpmap_first, const map_t* cpmap_second);
