 ...
 */
extern hash_set_t* _create_hash_set(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_hash_set_auxiliary(cSTL* pSTL,hash_set_t* phset_set, const char* s_typename);
 ...
 */
extern void _hash_set_destroy_auxiliary(cSTL* pSTL,hash_set_t* phset_set);
 ...
 */
extern hash_set_iterator_t _hash_set_find(cSTL* pSTL,const hash_set_t* cphset_set, ...);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern hash_set_iterator_t _hash_set_find_varg(cSTL* pSTL,const hash_set_t* cphset_set, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_set_count(cSTL* pSTL,const hash_set_t* cphset_set, ...);
 ...
 *          is undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_set_count_varg(cSTL* pSTL,const hash_set_t* cphset_set, va_list val_elemlist);
 ...
 */
extern range_t _hash_set_equal_range(cSTL* pSTL,const hash_set_t* cphset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern range_t _hash_set_equal_range_varg(cSTL* pSTL,const hash_set_t* cphset_set, va_list val_elemlist);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern hash_set_iterator_t _hash_set_insert(cSTL* pSTL,hash_set_t* phset_set, ...);
 ...
 *          undefined. the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
extern hash_set_iterator_t _hash_set_insert_varg(cSTL* pSTL,hash_set_t* phset_set, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _hash_set_erase(cSTL* pSTL,hash_set_t* phset_set, ...);
 ...
 *          undefined. 
 */
extern size_t _hash_set_erase_varg(cSTL* pSTL,hash_set_t* phset_set, va_list val_elemlist);
 ...
 */
extern void _hash_set_init_elem_auxiliary(cSTL* pSTL,hash_set_t* phset_set, void* pv_value);
