 ...
 */
extern _rb_tree_t* _create_rb_tree(cSTL* pSTL,const char* s_typename);
 ...
 */
extern void _rb_tree_init_copy(cSTL* pSTL,_rb_tree_t* pt_dest, const _rb_tree_t* cpt_src);
 ...
 *          is undefined.
 */
extern void _rb_tree_init_copy_equal_range(cSTL* pSTL,_rb_tree_t* pt_dest, iterator_t it_begin, iterator_t it_end);
 ...
 *          is undefined.
 */
extern void _rb_tree_init_copy_unique_range(cSTL* pSTL,_rb_tree_t* pt_dest, iterator_t it_begin, iterator_t it_end);
 ...
 *          is undefined.
 */
extern void _rb_tree_init_copy_equal_array(cSTL* pSTL,_rb_tree_t* pt_dest, const void* cpv_array, size_t t_count);
 ...
 *          is undefined.
 */
extern void _rb_tree_init_copy_unique_array(cSTL* pSTL,_rb_tree_t* pt_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void _rb_tree_init_copy_equal_range_ex(cSTL* pSTL,
 ...
 *          is undefined. if t_compare == NULL, then use default compare function.
 */
extern void _rb_tree_init_copy_unique_range_ex(cSTL* pSTL,
    _rb_tree_t* pt_dest, iterator_t it_begin, iterator_t it_end, binary_function_t t_compare);
 ...
 *          is undefined. if t_compare == NULL, then use default compare function.
 */
extern void _rb_tree_init_copy_equal_array_ex(cSTL* pSTL,
 ...
 *          is undefined. if t_compare == NULL, then use default compare function.
 */
extern void _rb_tree_init_copy_unique_array_ex(cSTL* pSTL,
    _rb_tree_t* pt_dest, const void* cpv_array, size_t t_count, binary_function_t t_compare);
 ...
 */
extern void _rb_tree_destroy(cSTL* pSTL,_rb_tree_t* pt_rb_tree);
 ...
 */
extern void _rb_tree_assign(cSTL* pSTL,_rb_tree_t* pt_dest, const _rb_tree_t* cpt_src);
 ...
 *          behavior is undefined.
 */
extern _rb_tree_iterator_t _rb_tree_find(cSTL* pSTL,const _rb_tree_t* cpt_rb_tree, const void* cpv_value);
 ...
 *          is undefined.
 */
extern void _rb_tree_clear(cSTL* pSTL,_rb_tree_t* pt_rb_tree);
 ...
 *          behavior is undefined.
 */
extern size_t _rb_tree_count(cSTL* pSTL,const _rb_tree_t* cpt_rb_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern _rb_tree_iterator_t _rb_tree_lower_bound(cSTL* pSTL,const _rb_tree_t* cpt_rb_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern _rb_tree_iterator_t _rb_tree_upper_bound(cSTL* pSTL,const _rb_tree_t* cpt_rb_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern range_t _rb_tree_equal_range(cSTL* pSTL,const _rb_tree_t* cpt_rb_tree, const void* cpv_value);
 ...
 */
extern bool_t _rb_tree_equal(cSTL* pSTL,const _rb_tree_t* pt_first, const _rb_tree_t* cpt_second);
 ...
 */
extern bool_t _rb_tree_not_equal(cSTL* pSTL,const _rb_tree_t* pt_first, const _rb_tree_t* cpt_second);
 ...
 */
extern bool_t _rb_tree_less(cSTL* pSTL,const _rb_tree_t* pt_first, const _rb_tree_t* cpt_second);
 ...
 */
extern bool_t _rb_tree_less_equal(cSTL* pSTL,const _rb_tree_t* pt_first, const _rb_tree_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return false.
 */
extern bool_t _rb_tree_greater(cSTL* pSTL,const _rb_tree_t* pt_first, const _rb_tree_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return true.
 */
extern bool_t _rb_tree_greater_equal(cSTL* pSTL,const _rb_tree_t* pt_first, const _rb_tree_t* cpt_second);
 ...
 */
extern void _rb_tree_swap(cSTL* pSTL,_rb_tree_t* pt_first, _rb_tree_t* pt_second);
 ...
 *          behavior is undefined.
 */
extern _rb_tree_iterator_t _rb_tree_insert_unique(cSTL* pSTL,_rb_tree_t* pt_rb_tree, const void* cpv_value);
 ...
 *          behavior is undefined.
 */
extern _rb_tree_iterator_t _rb_tree_insert_equal(cSTL* pSTL,_rb_tree_t* pt_rb_tree, const void* cpv_value);
 ...
 */
extern void _rb_tree_insert_unique_range(cSTL* pSTL,_rb_tree_t* pt_rb_tree, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void _rb_tree_insert_unique_array(cSTL* pSTL,_rb_tree_t* pt_rb_tree, const void* cpv_array, size_t t_count);
 ...
 *          [it_begin, it_end) must be valid range, otherwise the behavior is undefine.
 */
extern void _rb_tree_insert_equal_range(cSTL* pSTL,_rb_tree_t* pt_rb_tree, iterator_t it_begin, iterator_t it_end);
 ...
 *          array must be valid range, otherwise the behavior is undefine.
 */
extern void _rb_tree_insert_equal_array(cSTL* pSTL,_rb_tree_t* pt_rb_tree, const void* cpv_array, size_t t_count);
 ...
 */
extern void _rb_tree_erase_pos(cSTL* pSTL,_rb_tree_t* pt_rb_tree, _rb_tree_iterator_t t_pos);
 ...
 */
extern void _rb_tree_erase_range(cSTL* pSTL,_rb_tree_t* pt_rb_tree, _rb_tree_iterator_t it_begin, _rb_tree_iterator_t it_end);
 ...
 */
extern size_t _rb_tree_erase(cSTL* pSTL,_rb_tree_t* pt_rb_tree, const void* cpv_value);
