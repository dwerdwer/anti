 ...
 */
extern vector_t* _create_vector(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_vector_auxiliary(cSTL* pSTL,vector_t* pvec_vector, const char* s_typename);
 ...
 */
extern void _vector_init_elem(cSTL* pSTL,vector_t* pvec_vector, size_t t_count, ...);
 ...
 *          not in use. vector container must be created by create_vector, otherwise the behavior is undefined.
 */
extern void _vector_init_elem_varg(cSTL* pSTL,vector_t* pvec_vector, size_t t_count, va_list val_elemlist);
 ...
 */
extern void _vector_destroy_auxiliary(cSTL* pSTL,vector_t* pvec_vector);
 ...
 */
extern void _vector_assign_elem(cSTL* pSTL,vector_t* pvec_vector, size_t t_count, ...);
 ...
 *          in use, others are not in use.
 */
extern void _vector_assign_elem_varg(cSTL* pSTL,vector_t* pvec_vector, size_t t_count, va_list val_elemlist);
 ...
 *          in use, others are not in use.
 */
extern void _vector_push_back(cSTL* pSTL,vector_t* pvec_vector, ...);
 ...
 *          in use, others are not in use.
 */
extern void _vector_push_back_varg(cSTL* pSTL,vector_t* pvec_vector, va_list val_elemlist);
 ...
 *          element.
 */
extern void _vector_resize_elem(cSTL* pSTL,vector_t* pvec_vector, size_t t_resize, ...);
 ...
 */
extern void _vector_resize_elem_varg(cSTL* pSTL,vector_t* pvec_vector, size_t t_resize, va_list val_elemlist);
 ...
 *          in use.
 */
extern vector_iterator_t _vector_insert_n(cSTL* pSTL,
 ...
 */
extern vector_iterator_t _vector_insert_n_varg(cSTL* pSTL,
 ...
 */
extern void _vector_init_elem_auxiliary(cSTL* pSTL,vector_t* pvec_vector, void* pv_elem);
