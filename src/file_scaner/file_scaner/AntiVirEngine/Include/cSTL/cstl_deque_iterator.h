 ...
 */
extern void _deque_iterator_get_value(cSTL* pSTL,deque_iterator_t it_iter, void* pv_value);
 ...
 *          then the behavior is undefined.
 */
extern void _deque_iterator_set_value(cSTL* pSTL,deque_iterator_t it_iter, const void* cpv_value);
