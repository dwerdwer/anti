 ...
 * @param pv_value point to buffer that be used to spSTL date.
 * @return void.
 * @remarks it_iter must be valid vector iterator, otherwise the behavior is undefined. if pv_value == NULL,
 *          then the behavior is undefined.
 */
extern void _vector_iterator_get_value(cSTL* pSTL,vector_iterator_t it_iter, void* pv_value);

/**
 * Set iterator reference data.
 * @param it_iter vector iterator.
 * @param cpv_value point to buffer that be used to spSTL date.
 * @return void.
 * @remarks it_iter must be valid vector iterator, otherwise the behavior is undefined. if pv_value == NULL,
 *          then the behavior is undefined.
 */
extern void _vector_iterator_set_value(cSTL* pSTL,vector_iterator_t it_iter, const void* cpv_value);
