 ...
 */
#define create_set(pSTL,...) _create_set(pSTL,#__VA_ARGS__) 
 ...
 */
#define set_find(pSTL,cpset_set, elem) _set_find((pSTL),(cpset_set), (elem))
 ...
 *          the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
#define set_count(pSTL,cpset_set, elem) _set_count((pSTL),(cpset_set), (elem))
 ...
 *          the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
#define set_lower_bound(pSTL,cpset_set, elem) _set_lower_bound((pSTL),(cpset_set), (elem))
 ...
 *          the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
#define set_upper_bound(pSTL,cpset_set, elem) _set_upper_bound((pSTL),(cpset_set), (elem))
 ...
 *          the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
#define set_equal_range(pSTL,cpset_set, elem) _set_equal_range((pSTL),(cpset_set), (elem))
 ...
 */
#define set_erase(pSTL,pset_set, elem) _set_erase((pSTL),(pset_set), (elem))
 ...
 *          the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
#define set_insert(pSTL,pset_set, elem) _set_insert((pSTL),(pset_set), (elem))
 ...
 *          the type of specific element and cpset_set must be same, otherwise the behavior is undefined.
 */
#define set_insert_hint(pSTL,pset_set, it_hint, elem) _set_insert_hint((pSTL),(pset_set), (it_hint), (elem))
 ...
 */
extern void _set_init(set_t* pset_set);
 ...
 */
extern void set_init_copy(cSTL* pSTL,set_t* pset_dest, const set_t* cpset_src);
 ...
 *          is undefined.
 */
extern void set_init_copy_range(cSTL* pSTL,set_t* pset_dest, iterator_t it_begin, iterator_t it_end);
 ...
 *          is undefined.
 */
extern void set_init_copy_array(cSTL* pSTL,set_t* pset_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void set_init_copy_range_ex(cSTL* pSTL,
 ...
 *          is undefined. if bfun_compare == NULL, then use default compare function.
 */
extern void set_init_copy_array_ex(cSTL* pSTL,
 ...
 */
extern void set_destroy(cSTL* pSTL,set_t* pset_set);
 ...
 */
extern void set_assign(cSTL* pSTL,set_t* pset_dest, const set_t* cpset_src);
 ...
 *          is undefined.
 */
extern size_t _set_size(const set_t* cpset_set);
 ...
 * @remarks if cpset_set == NULL, the behavior is undefined. cpset_set must be initialized, otherwise the behavior is undefined.
 */
extern set_iterator_t _set_end(const set_t* cpset_set);
/* private */
extern set_reverse_iterator_t set_rbegin(const set_t* cpset_set);
extern set_reverse_iterator_t _set_rend(const set_t* cpset_set);
 ...
 */
extern void set_clear(cSTL* pSTL,set_t* pset_set);
 ...
 */
extern bool_t set_equal(cSTL* pSTL,const set_t* cpset_first, const set_t* cpset_second);
 ...
 */
extern bool_t set_not_equal(cSTL* pSTL,const set_t* cpset_first, const set_t* cpset_second);
 ...
 */
extern bool_t _set_less(cSTL* pSTL,const set_t* cpset_first, const set_t* cpset_second);
 ...
 */
extern bool_t set_less_equal(cSTL* pSTL,const set_t* cpset_first, const set_t* cpset_second);
 ...
 *          undefined. if cpset_first == cpset_second, then return false.
 */
extern bool_t set_greater(cSTL* pSTL,const set_t* cpset_first, const set_t* cpset_second);
 ...
 *          undefined. if cpset_first == cpset_second, then return true.
 */
extern bool_t set_greater_equal(cSTL* pSTL,const set_t* cpset_first, const set_t* cpset_second);
 ...
 */
extern void _set_swap(cSTL* pSTL,set_t* pset_first, set_t* pset_second);
 ...
 */
extern void set_insert_range(cSTL* pSTL,set_t* pset_set, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void set_insert_array(cSTL* pSTL,set_t* pset_set, const void* cpv_array, size_t t_count);
 ...
 */
extern void set_erase_pos(cSTL* pSTL,set_t* pset_set, set_iterator_t it_pos);
 ...
 */
extern void set_erase_range(cSTL* pSTL,set_t* pset_set, set_iterator_t it_begin, set_iterator_t it_end);
