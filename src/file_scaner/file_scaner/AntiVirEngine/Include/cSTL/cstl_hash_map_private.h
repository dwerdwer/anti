 ...
 */
extern hash_map_t* _create_hash_map(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_hash_map_auxiliary(cSTL* pSTL,hash_map_t* phmap_map, const char* s_typename);
 ...
 */
extern void _hash_map_destroy_auxiliary(cSTL* pSTL,hash_map_t* phmap_map);
 ...
 */
extern hash_map_iterator_t _hash_map_find(cSTL* pSTL,const hash_map_t* cphmap_map, ...);
 ...
 *          is undefined. the type of specific element and cphmap_map must be same, otherwise the behavior is undefined.
 */
extern hash_map_iterator_t _hash_map_find_varg(cSTL* pSTL,const hash_map_t* cphmap_map, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cphmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_map_count(cSTL* pSTL,const hash_map_t* cphmap_map, ...);
 ...
 *          is undefined. the type of specific element and cphmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_map_count_varg(cSTL* pSTL,const hash_map_t* cphmap_map, va_list val_elemlist);
 ...
 */
extern range_t _hash_map_equal_range(cSTL* pSTL,const hash_map_t* cphmap_map, ...);
 ...
 *          undefined. the type of specific element and cphmap_map must be same, otherwise the behavior is undefined.
 */
extern range_t _hash_map_equal_range_varg(cSTL* pSTL,const hash_map_t* cphmap_map, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern void* _hash_map_at(cSTL* pSTL,hash_map_t* phmap_map, ...);
 ...
 *          undefined. 
 */
extern void* _hash_map_at_varg(cSTL* pSTL,hash_map_t* phmap_map, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _hash_map_erase(cSTL* pSTL,hash_map_t* phmap_map, ...);
 ...
 *          undefined. 
 */
extern size_t _hash_map_erase_varg(cSTL* pSTL,hash_map_t* phmap_map, va_list val_elemlist);
