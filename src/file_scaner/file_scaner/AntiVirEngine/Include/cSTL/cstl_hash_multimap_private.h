 ...
 */
extern bool_t _create_hash_multimap_auxiliary(cSTL* pSTL,hash_multimap_t* phmmap_map, const char* s_typename);
 ...
 */
extern void _hash_multimap_destroy_auxiliary(cSTL* pSTL,hash_multimap_t* phmmap_map);
 ...
 */
extern hash_multimap_iterator_t _hash_multimap_find(cSTL* pSTL,const hash_multimap_t* cphmmap_map, ...);
 ...
 *          is undefined. the type of specific element and cphmmap_map must be same, otherwise the behavior is undefined.
 */
extern hash_multimap_iterator_t _hash_multimap_find_varg(cSTL* pSTL,const hash_multimap_t* cphmmap_map, va_list val_elemlist);
 ...
 *          is undefined. the type of specific element and cphmmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_multimap_count(cSTL* pSTL,const hash_multimap_t* cphmmap_map, ...);
 ...
 *          is undefined. the type of specific element and cphmmap_map must be same, otherwise the behavior is undefined.
 */
extern size_t _hash_multimap_count_varg(cSTL* pSTL,const hash_multimap_t* cphmmap_map, va_list val_elemlist);
 ...
 */
extern range_t _hash_multimap_equal_range(cSTL* pSTL,const hash_multimap_t* cphmmap_map, ...);
 ...
 *          undefined. the type of specific element and cphmmap_map must be same, otherwise the behavior is undefined.
 */
extern range_t _hash_multimap_equal_range_varg(cSTL* pSTL,const hash_multimap_t* cphmmap_map, va_list val_elemlist);
 ...
 *          undefined. 
 */
extern size_t _hash_multimap_erase(cSTL* pSTL,hash_multimap_t* phmmap_map, ...);
 ...
 *          undefined. 
 */
extern size_t _hash_multimap_erase_varg(cSTL* pSTL,hash_multimap_t* phmmap_map, va_list val_elemlist);
