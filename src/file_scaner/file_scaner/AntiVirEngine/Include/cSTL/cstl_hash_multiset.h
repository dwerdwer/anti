 ...
 */
extern void hash_multiset_init(cSTL* pSTL,hash_multiset_t* phmset_set);
 ...
 */
extern void hash_multiset_init_ex(cSTL* pSTL,
 ...
 */
extern void hash_multiset_init_copy(cSTL* pSTL,hash_multiset_t* phmset_dest, const hash_multiset_t* cphmset_src);
 ...
 */
extern void hash_multiset_init_copy_range(cSTL* pSTL,hash_multiset_t* phmset_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void hash_multiset_init_copy_array(cSTL* pSTL,hash_multiset_t* phmset_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_multiset_init_copy_range_ex(cSTL* pSTL,hash_multiset_t* phmset_dest, iterator_t it_begin, iterator_t it_end,
 ...
 *          bfun_compare == NULL, then use default compare function.
 */
extern void hash_multiset_init_copy_array_ex(cSTL* pSTL,hash_multiset_t* phmset_dest, const void* cpv_array, size_t t_count,
    size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void hash_multiset_destroy(cSTL* pSTL,hash_multiset_t* phmset_set);
 ...
 */
extern void hash_multiset_assign(cSTL* pSTL,hash_multiset_t* phmset_dest, const hash_multiset_t* cphmset_src);
 ...
 */
extern void hash_multiset_swap(cSTL* pSTL,hash_multiset_t* phmset_first, hash_multiset_t* phmset_second);
 ...
 *          is undefined.
 */
extern void hash_multiset_resize(cSTL* pSTL,hash_multiset_t* phmset_set, size_t t_resize);
 ...
 */
extern bool_t hash_multiset_equal(cSTL* pSTL,const hash_multiset_t* cphmset_first, const hash_multiset_t* cphmset_second);
 ...
 */
extern bool_t hash_multiset_not_equal(cSTL* pSTL,const hash_multiset_t* cphmset_first, const hash_multiset_t* cphmset_second);
 ...
 */
extern bool_t hash_multiset_less(cSTL* pSTL,const hash_multiset_t* cphmset_first, const hash_multiset_t* cphmset_second);
 ...
 */
extern bool_t hash_multiset_less_equal(cSTL* pSTL,const hash_multiset_t* cphmset_first, const hash_multiset_t* cphmset_second);
 ...
 *          undefined. if cphmset_first == cphmset_second, then return false.
 */
extern bool_t hash_multiset_greater(cSTL* pSTL,const hash_multiset_t* cphmset_first, const hash_multiset_t* cphmset_second);
 ...
 *          undefined. if cphmset_first == cphmset_second, then return true.
 */
extern bool_t hash_multiset_greater_equal(cSTL* pSTL,const hash_multiset_t* cphmset_first, const hash_multiset_t* cphmset_second);
 ...
 */
extern void hash_multiset_insert_range(cSTL* pSTL,hash_multiset_t* phmset_set, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void hash_multiset_insert_array(cSTL* pSTL,hash_multiset_t* phmset_set, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_multiset_erase_pos(cSTL* pSTL,hash_multiset_t* phmset_set, hash_multiset_iterator_t it_pos);
 ...
 */
extern void hash_multiset_erase_range(cSTL* pSTL,
 ...
 */
extern void hash_multiset_clear(cSTL* pSTL,hash_multiset_t* phmset_set);
