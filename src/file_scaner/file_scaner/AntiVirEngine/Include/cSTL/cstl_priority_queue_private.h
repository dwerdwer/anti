...
extern bool_t _create_priority_queue_auxiliary(cSTL* pSTL,
    priority_queue_t* pt_pqueue, const char* s_typename);
extern void _priority_queue_destroy_auxiliary(cSTL* pSTL,priority_queue_t* pt_queue);

/*
 * Append a copy of element at the top.
 */
extern void _priority_queue_push(cSTL* pSTL,priority_queue_t* pt_pqueue, ...);
