 ...
 */
#define create_basic_string(pSTL,...) _create_basic_string(pSTL,#__VA_ARGS__)
 ...
 */
#define basic_string_init_elem(pSTL,pt_basic_string, t_count, elem)\
    _basic_string_init_elem((pSTL),(pt_basic_string), (t_count), (elem))
 ...
 */
#define basic_string_connect_elem(pSTL,pt_basic_string, elem) _basic_string_connect_elem((pSTL),(pt_basic_string), (elem))
 ...
 *          NPOS.
 */
#define basic_string_find_elem(pSTL,cpt_basic_string, elem, t_pos) _basic_string_find_elem((pSTL),(cpt_basic_string), (t_pos), (elem))
 ...
 */
#define basic_string_rfind_elem(pSTL,cpt_basic_string, elem, t_pos) _basic_string_rfind_elem((pSTL),(cpt_basic_string), (t_pos), (elem))
 ...
 *          NPOS.
 */
#define basic_string_find_first_of_elem(pSTL,cpt_basic_string, elem, t_pos)\
    _basic_string_find_elem((pSTL),(cpt_basic_string), (t_pos), (elem))
 ...
 *          NPOS.
 */
#define basic_string_find_first_not_of_elem(pSTL,cpt_basic_string, elem, t_pos)\
    _basic_string_find_first_not_of_elem((pSTL),(cpt_basic_string), (t_pos), (elem))
 ...
 *          then finding begin with the last element.
 */
#define basic_string_find_last_of_elem(pSTL,cpt_basic_string, elem, t_pos)\
    _basic_string_rfind_elem((pSTL),(cpt_basic_string), (t_pos), (elem))
 ...
 *          then finding begin with the last element.
 */
#define basic_string_find_last_not_of_elem(pSTL,cpt_basic_string, elem, t_pos)\
    _basic_string_find_last_not_of_elem((pSTL),(cpt_basic_string), (t_pos), (elem))
 ...
 * @remarks if pt_basic_string == NULL or uninitialized, then the bahavior is undefine.
 */
#define basic_string_push_back(pSTL,pt_basic_string, elem) _basic_string_push_back((pSTL),(pt_basic_string), (elem))
 ...
 */
#define basic_string_resize(pSTL,pt_basic_string, t_resize, elem) _basic_string_resize((pSTL),(pt_basic_string), (t_resize), (elem))
 ...
 */
#define basic_string_assign_elem(pSTL,pt_basic_string, t_count, elem)\
    _basic_string_assign_elem((pSTL),(pt_basic_string), (t_count), (elem))
 ...
 *          specificed element and basic_string element type must be same, otherwise the behavior is undefined.
 */
#define basic_string_append_elem(pSTL,pt_basic_string, t_count, elem)\
    _basic_string_append_elem((pSTL),(pt_basic_string), (t_count), (elem))
 ...
 */
#define basic_string_insert(pSTL,pt_basic_string, it_pos, elem)\
    _basic_string_insert((pSTL),(pt_basic_string), (it_pos), (elem))
 ...
 *          and basic_string element type must be same, otherwise the behavior is undefined. 
 */
#define basic_string_insert_n(pSTL,pt_basic_string, it_pos, t_count, elem)\
    _basic_string_insert_n((pSTL),(pt_basic_string), (it_pos), (t_count), (elem))
 ...
 */
#define basic_string_insert_elem(pSTL,pt_basic_string, t_pos, t_count, elem)\
    _basic_string_insert_elem((pSTL),(pt_basic_string), (t_pos), (t_count), (elem))
 ...
 */
#define basic_string_range_replace_elem(pSTL,pt_basic_string, it_begin, it_end, t_count, elem)\
    _basic_string_range_replace_elem((pSTL),(pt_basic_string), (it_begin), (it_end), (t_count), (elem))
 ...
 */
#define basic_string_replace_elem(pSTL,pt_basic_string, t_pos, t_len, t_count, elem)\
    _basic_string_replace_elem((pSTL),(pt_basic_string), (t_pos), (t_len), (t_count), (elem))
 ...
 */
extern void basic_string_init(cSTL* pSTL,basic_string_t* pt_basic_string);
 ...
 */
extern void basic_string_init_cstr(cSTL* pSTL,basic_string_t* pt_basic_string, const void* cpv_value_string);
 ...
 */
extern void basic_string_init_subcstr(cSTL* pSTL,basic_string_t* pt_basic_string, const void* cpv_value_string, size_t t_len);
 ...
 */
extern void basic_string_init_copy(cSTL* pSTL,basic_string_t* pt_dest, const basic_string_t* cpt_src);
 ...
 */
extern void basic_string_init_copy_substring(cSTL* pSTL,
 ...
 */
extern void basic_string_init_copy_range(cSTL* pSTL,
 ...
 */
extern void basic_string_destroy(cSTL* pSTL,basic_string_t* pt_basic_string);
 ...
 */
extern size_t basic_string_copy(cSTL* pSTL,const basic_string_t* cpt_basic_string, void* pv_buffer, size_t t_len, size_t t_pos);
 ...
 */
extern bool_t basic_string_equal(cSTL* pSTL,const basic_string_t* cpt_first, const basic_string_t* cpt_second);
 ...
 */
extern bool_t basic_string_not_equal(cSTL* pSTL,const basic_string_t* cpt_first, const basic_string_t* cpt_second);
 ...
 */
extern bool_t basic_string_less(cSTL* pSTL,const basic_string_t* cpt_first, const basic_string_t* cpt_second);
 ...
 */
extern bool_t basic_string_less_equal(cSTL* pSTL,const basic_string_t* cpt_first, const basic_string_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return false.
 */
extern bool_t basic_string_greater(cSTL* pSTL,const basic_string_t* cpt_first, const basic_string_t* cpt_second);
 ...
 *          undefined. if cpt_first == cpt_second, then return true.
 */
extern bool_t basic_string_greater_equal(cSTL* pSTL,const basic_string_t* cpt_first, const basic_string_t* cpt_second);
 ...
 */
extern bool_t basic_string_equal_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string);
 ...
 *          type, the behavior is undefined.
 */
extern bool_t basic_string_not_equal_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string); 
 ...
 */
extern bool_t basic_string_less_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string); 
 ...
 *          the behavior is undefined.
 */
extern bool_t basic_string_less_equal_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string); 
 ...
 *          the behavior is undefined.
 */
extern bool_t basic_string_greater_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string); 
 ...
 *          the behavior is undefined.
 */
extern bool_t basic_string_greater_equal_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string); 
 ...
 */
extern int basic_string_compare(cSTL* pSTL,const basic_string_t* cpt_first, const basic_string_t* cpt_second);
 ...
 */
extern int basic_string_compare_substring_string(cSTL* pSTL,
 ...
 */
extern int basic_string_compare_substring_substring(cSTL* pSTL,
 ...
 *          type, the behavior is undefined.
 */
extern int basic_string_compare_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string);
 ...
 */
extern int basic_string_compare_substring_subcstr(cSTL* pSTL,
 ...
 *          is undefine.
 */
extern void basic_string_connect(cSTL* pSTL,basic_string_t* pt_dest, const basic_string_t* cpt_src);
 ...
 */
extern void basic_string_connect_cstr(cSTL* pSTL,basic_string_t* pt_basic_string, const void* cpv_value_string);
 ...
 */
extern size_t basic_string_find(cSTL* pSTL,const basic_string_t* cpt_basic_string, const basic_string_t* cpt_find, size_t t_pos);
 ...
 */
extern size_t basic_string_find_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos);
 ...
 */
extern size_t basic_string_find_subcstr(cSTL* pSTL,
 ...
 */
extern size_t basic_string_rfind(cSTL* pSTL,const basic_string_t* cpt_basic_string, const basic_string_t* cpt_find, size_t t_pos);
 ...
 */
extern size_t basic_string_rfind_cstr(cSTL* pSTL,const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos);
 ...
 *          the length of value string, then use all value string.
 */
extern size_t basic_string_rfind_subcstr(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos, size_t t_len);
 ...
 *          undefined. if cpt_find is empty, then return t_pos.
 */
extern size_t basic_string_find_first_of(cSTL* pSTL,
 ...
 *          behavior is undefined. if cpv_value_string is empty, then return t_pos.
 */
extern size_t basic_string_find_first_of_cstr(cSTL* pSTL,
 ...
 *          the length of value string, then use all value string.
 */
extern size_t basic_string_find_first_of_subcstr(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos, size_t t_len);
 ...
 *          undefined. if cpt_find is empty, then return t_pos.
 */
extern size_t basic_string_find_first_not_of(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const basic_string_t* cpt_find, size_t t_pos);
 ...
 *          behavior is undefined. if cpv_value_string is empty, then return t_pos.
 */
extern size_t basic_string_find_first_not_of_cstr(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos);
 ...
 *          the length of value string, then use all value string.
 */
extern size_t basic_string_find_first_not_of_subcstr(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos, size_t t_len);
 ...
 *          element. if cpt_find is empty, then return t_pos;
 */
extern size_t basic_string_find_last_of(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const basic_string_t* cpt_find, size_t t_pos);
 ...
 *          the length of value string, then use all value string.
 */
extern size_t basic_string_find_last_of_subcstr(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos, size_t t_len);
 ...
 *          element. if cpt_find is empty, then return t_pos;
 */
extern size_t basic_string_find_last_not_of(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const basic_string_t* cpt_find, size_t t_pos);
 ...
 *          from the last element. if cpv_value_string is empty, then return t_pos;
 */
extern size_t basic_string_find_last_not_of_cstr(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos);
 ...
 *          the length of value string, then use all value string.
 */
extern size_t basic_string_find_last_not_of_subcstr(cSTL* pSTL,
    const basic_string_t* cpt_basic_string, const void* cpv_value_string, size_t t_pos, size_t t_len);
 ...
 *          behavior is undefined.
 */
extern void basic_string_clear(cSTL* pSTL,basic_string_t* pt_basic_string);
 ...
 *          does nothing.
 */
extern void basic_string_swap(cSTL* pSTL,basic_string_t* pt_first, basic_string_t* pt_second);
 ...
 */
extern void basic_string_reserve(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_reservesize);
 ...
 */
extern void basic_string_assign(cSTL* pSTL,basic_string_t* pt_dest,  const basic_string_t* cpt_src);
 ...
 */
extern void basic_string_assign_substring(cSTL* pSTL,basic_string_t* pt_dest, const basic_string_t* cpt_src, size_t t_pos, size_t t_len);
 ...
 *          otherwise the behavior is undefined.
 */
extern void basic_string_assign_cstr(cSTL* pSTL,basic_string_t* pt_basic_string, const void* cpv_value_string);
 ...
 *          all value string.
 */
extern void basic_string_assign_subcstr(cSTL* pSTL,basic_string_t* pt_basic_string, const void* cpv_value_string, size_t t_len);
 ...
 */
extern void basic_string_assign_range(cSTL* pSTL,
    basic_string_t* pt_basic_string, basic_string_iterator_t it_begin, basic_string_iterator_t it_end);
 ...
 *          is undefined.
 */
extern void basic_string_append(cSTL* pSTL,basic_string_t* pt_dest, const basic_string_t* cpt_src);
 ...
 *          t_len == NPOS or t_pos + t_len >= basic_string_size(cpt_src), then use all remain source basic string.
 */
extern void basic_string_append_substring(cSTL* pSTL,basic_string_t* pt_dest, const basic_string_t* cpt_src, size_t t_pos, size_t t_len);
 ...
 *          otherwise the behavior is undefined.
 */
extern void basic_string_append_cstr(cSTL* pSTL,basic_string_t* pt_basic_string, const void* cpv_value_string);
 ...
 *          all value string.
 */
extern void basic_string_append_subcstr(cSTL* pSTL,basic_string_t* pt_basic_string, const void* cpv_value_string, size_t t_len);
 ...
 *          behavior is undefined. if [it_begin, it_end) belong to the destination basic_string, the behavior is undefined.
 */
extern void basic_string_append_range(cSTL* pSTL,
    basic_string_t* pt_basic_string, basic_string_iterator_t it_begin, basic_string_iterator_t it_end);
 ...
 */
extern void basic_string_insert_string(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_pos, const basic_string_t* cpt_insert);
 ...
 */
extern void basic_string_insert_substring(cSTL* pSTL,
 ...
 *          behavior is undefined.
 */
extern void basic_string_insert_cstr(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_pos, const void* cpv_value_string);
 ...
 */
extern void basic_string_insert_subcstr(cSTL* pSTL,
 ...
 */
extern void basic_string_insert_range(cSTL* pSTL,
 ...
 *          the behavior is undefined.
 */
extern basic_string_iterator_t basic_string_erase(cSTL* pSTL,basic_string_t* pt_basic_string, basic_string_iterator_t it_pos);
 ...
 *          the behavior is undefined. [it_begin, it_end) must be valid range, otherwise the behavior is undefine.
 */
extern basic_string_iterator_t basic_string_erase_range(cSTL* pSTL,
    basic_string_t* pt_basic_string, basic_string_iterator_t it_begin, basic_string_iterator_t it_end);
 ...
 */
extern void basic_string_erase_substring(cSTL* pSTL,basic_string_t* pt_basic_string, size_t t_pos, size_t t_len);
 ...
 */
extern void basic_string_replace(cSTL* pSTL,
 ...
 */
extern void basic_string_replace_substring(cSTL* pSTL,
 ...
 */
extern void basic_string_replace_cstr(cSTL* pSTL,
 ...
 */
extern void basic_string_replace_subcstr(cSTL* pSTL,
 ...
 */
extern void basic_string_range_replace(cSTL* pSTL,
 ...
 */
extern void basic_string_range_replace_substring(cSTL* pSTL,
    basic_string_t* pt_basic_string, basic_string_iterator_t it_begin, basic_string_iterator_t it_end,
    const basic_string_t* cpt_replace, size_t t_position, size_t t_length);
 ...
 *          otherwise the behavior is undefined.
 */
extern void basic_string_range_replace_cstr(cSTL* pSTL,
    basic_string_t* pt_basic_string, basic_string_iterator_t it_begin,
 ...
 *          cpv_value_string, then use all cpv_value_string.
 */
extern void basic_string_range_replace_subcstr(cSTL* pSTL,
    basic_string_t* pt_basic_string, basic_string_iterator_t it_begin, basic_string_iterator_t it_end,
 ...
 */
extern void basic_string_replace_range(cSTL* pSTL,
