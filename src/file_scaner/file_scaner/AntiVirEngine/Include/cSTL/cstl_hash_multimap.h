 ...
 */
extern void hash_multimap_init(cSTL* pSTL,hash_multimap_t* phmmap_map);
 ...
 */
extern void hash_multimap_init_ex(cSTL* pSTL,hash_multimap_t* phmmap_map, size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void hash_multimap_init_copy(cSTL* pSTL,hash_multimap_t* phmmap_dest, const hash_multimap_t* cphmmap_src);
 ...
 *          is undefined.
 */
extern void hash_multimap_init_copy_range(cSTL* pSTL,hash_multimap_t* phmmap_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void hash_multimap_init_copy_array(cSTL* pSTL,hash_multimap_t* phmmap_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_multimap_init_copy_range_ex(cSTL* pSTL,hash_multimap_t* phmmap_dest, iterator_t it_begin, iterator_t it_end,
 ...
 */
extern void hash_multimap_init_copy_array_ex(cSTL* pSTL,hash_multimap_t* phmmap_dest, const void* cpv_array, size_t t_count,
    size_t t_bucketcount, unary_function_t ufun_hash, binary_function_t bfun_compare);
 ...
 */
extern void hash_multimap_destroy(cSTL* pSTL,hash_multimap_t* phmmap_map);
 ...
 */
extern void hash_multimap_assign(cSTL* pSTL,hash_multimap_t* phmmap_dest, const hash_multimap_t* cphmmap_src);
 ...
 */
extern void hash_multimap_swap(cSTL* pSTL,hash_multimap_t* phmmap_first, hash_multimap_t* phmmap_second);
 ...
 * @remarks if cphmmap_map == NULL, the behavior is undefined. cphmmap_map must be initialized, otherwise the behavior is undefined.
 */
extern void hash_multimap_resize(cSTL* pSTL,hash_multimap_t* phmmap_map, size_t t_resize);
 ...
 */
extern bool_t hash_multimap_equal(cSTL* pSTL,const hash_multimap_t* cphmmap_first, const hash_multimap_t* cphmmap_second);
 ...
 */
extern bool_t hash_multimap_not_equal(cSTL* pSTL,const hash_multimap_t* cphmmap_first, const hash_multimap_t* cphmmap_second);
 ...
 */
extern bool_t hash_multimap_less(cSTL* pSTL,const hash_multimap_t* cphmmap_first, const hash_multimap_t* cphmmap_second);
 ...
 */
extern bool_t hash_multimap_less_equal(cSTL* pSTL,const hash_multimap_t* cphmmap_first, const hash_multimap_t* cphmmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return false.
 */
extern bool_t hash_multimap_greater(cSTL* pSTL,const hash_multimap_t* cphmmap_first, const hash_multimap_t* cphmmap_second);
 ...
 *          undefined. if cpmap_first == cpmap_second, then return true.
 */
extern bool_t hash_multimap_greater_equal(cSTL* pSTL,const hash_multimap_t* cphmmap_first, const hash_multimap_t* cphmmap_second);
 ...
 *          the type of specific element and cphmmap_map must be same, otherwise the behavior is undefined.
 */
extern hash_multimap_iterator_t hash_multimap_insert(cSTL* pSTL,hash_multimap_t* phmmap_map, const pair_t* cppair_pair);
 ...
 */
extern void hash_multimap_insert_range(cSTL* pSTL,hash_multimap_t* phmmap_map, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void hash_multimap_insert_array(cSTL* pSTL,hash_multimap_t* phmmap_map, const void* cpv_array, size_t t_count);
 ...
 */
extern void hash_multimap_erase_pos(cSTL* pSTL,hash_multimap_t* phmmap_map, hash_multimap_iterator_t it_pos);
 ...
 */
extern void hash_multimap_erase_range(cSTL* pSTL,hash_multimap_t* phmmap_map, hash_multimap_iterator_t it_begin, hash_multimap_iterator_t it_end);
 ...
 */
extern void hash_multimap_clear(cSTL* pSTL,hash_multimap_t* phmmap_map);
