 ...
 */
#define create_pair(pSTL,...) _create_pair(pSTL,#__VA_ARGS__)
 ...
 */
#define pair_make(pSTL,ppair_pair, first_elem, second_elem)\
    _pair_make_first((pSTL),(ppair_pair),(first_elem)),_pair_make_second((pSTL),(ppair_pair),(second_elem))
 ...
 */
extern void pair_init(cSTL* pSTL,pair_t* ppair_pair);
 ...
 */
extern void pair_destroy(cSTL* pSTL,pair_t* ppair_pair);
 ...
 */
extern void pair_assign(cSTL* pSTL,pair_t* ppair_dest, const pair_t* cppair_src);
 ...
 */
extern bool_t pair_equal(cSTL* pSTL,const pair_t* cppair_first, const pair_t* cppair_second);
 ...
 */
extern bool_t pair_not_equal(cSTL* pSTL,const pair_t* cppair_first, const pair_t* cppair_second);
 ...
 */
extern bool_t pair_less(cSTL* pSTL,const pair_t* cppair_first, const pair_t* cppair_second);
 ...
 */
extern bool_t pair_less_equal(cSTL* pSTL,const pair_t* cppair_first, const pair_t* cppair_second);
 ...
 *          undefined. if cppair_first == cppair_second, then return false.
 */
extern bool_t pair_greater(cSTL* pSTL,const pair_t* cppair_first, const pair_t* cppair_second);
 ...
 *          undefined. if cppair_first == cppair_second, then return true.
 */
extern bool_t pair_greater_equal(cSTL* pSTL,const pair_t* cppair_first, const pair_t* cppair_second);
