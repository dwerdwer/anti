 ...
 */
extern void priority_queue_init(cSTL* pSTL,priority_queue_t* pt_pqueue);
extern void priority_queue_init_ex(cSTL* pSTL,
    priority_queue_t* pt_pqueue, binary_function_t t_binary_op);
extern void priority_queue_destroy(cSTL* pSTL,priority_queue_t* pt_pqueue);
extern void priority_queue_init_copy(cSTL* pSTL,
    priority_queue_t* pt_pqueuedest, const priority_queue_t* cpt_pqueuesrc);
extern void priority_queue_init_copy_range(cSTL* pSTL,
    priority_queue_t* pt_pqueuedest,
    random_access_iterator_t t_first, random_access_iterator_t t_last);
extern void priority_queue_init_copy_range_ex(cSTL* pSTL,
 ...
 */
extern void priority_queue_assign(cSTL* pSTL,
    priority_queue_t* pt_pqueuedest, const priority_queue_t* cpt_pqueuesrc);
 ...
 */
extern void priority_queue_pop(cSTL* pSTL,priority_queue_t* pt_pqueue);
