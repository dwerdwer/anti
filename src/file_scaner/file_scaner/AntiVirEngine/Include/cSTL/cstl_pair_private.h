 ...
 */
extern pair_t* _create_pair(cSTL* pSTL,const char* s_typename);
 ...
 */
extern bool_t _create_pair_auxiliary(cSTL* pSTL,pair_t* ppair_pair, const char* s_typename);
 ...
 */
extern void _pair_destroy_auxiliary(cSTL* pSTL,pair_t* ppair_pair);
 ...
 */
extern void _pair_make_first(cSTL* pSTL,pair_t* ppair_pair, ...);
 ...
 * @remarks if ppair_pair == NULL, then the behavior is undefined. pair must be initialized, otherwise the behavior is undefine.
 */
extern void _pair_make_second(cSTL* pSTL,pair_t* ppair_pair, ...);
