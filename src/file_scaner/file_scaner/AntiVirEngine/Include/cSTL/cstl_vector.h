...
/**
 * Create vector container that spSTL specificed element type.
 ...
 */
#define create_vector(pSTL,...) _create_vector(pSTL,#__VA_ARGS__) 
 ...
 */
#define vector_init_elem(pSTL,pvec_vector, t_count, elem) _vector_init_elem((pSTL),(pvec_vector), (t_count), (elem))
 ...
 */
#define vector_assign_elem(pSTL,pvec_vector, t_count, elem) _vector_assign_elem((pSTL),(pvec_vector), (t_count), (elem))
 ...
 *          element and vector element type must be same, otherwise the behavior is undefined.
 */
#define vector_push_back(pSTL,pvec_vector, elem) _vector_push_back((pSTL),(pvec_vector), (elem))
 ...
 */
#define vector_resize_elem(pSTL,pvec_vector, t_resize, elem) _vector_resize_elem((pSTL),(pvec_vector), (t_resize), (elem))
 ...
 */
#define vector_insert(pSTL,pvec_vector, it_pos, elem) _vector_insert_n((pSTL),(pvec_vector), (it_pos), 1, (elem))
 ...
 *          behavior is undefined.
 */
#define vector_insert_n(pSTL,pvec_vector, it_pos, t_count, elem) _vector_insert_n((pSTL),(pvec_vector), (it_pos), (t_count), (elem))
 ...
 */
extern void vector_init(cSTL* pSTL,vector_t* pvec_vector);
 ...
 */
extern void vector_init_n(cSTL* pSTL,vector_t* pvec_vector, size_t t_count);
 ...
 */
extern void vector_init_copy(cSTL* pSTL,vector_t* pvec_dest, const vector_t* cpvec_src);
 ...
 */
extern void vector_init_copy_range(cSTL* pSTL,vector_t* pvec_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void vector_destroy(cSTL* pSTL,vector_t* pvec_vector);
 ...
 */
extern void vector_reserve(cSTL* pSTL,vector_t* pvec_vector, size_t t_reservesize);
 ...
 */
extern bool_t vector_equal(cSTL* pSTL,const vector_t* cpvec_first, const vector_t* cpvec_second);
 ...
 */
extern bool_t vector_not_equal(cSTL* pSTL,const vector_t* cpvec_first, const vector_t* cpvec_second);
 ...
 */
extern bool_t vector_less(cSTL* pSTL,const vector_t* cpvec_first, const vector_t* cpvec_second);
 ...
 */
extern bool_t vector_less_equal(cSTL* pSTL,const vector_t* cpvec_first, const vector_t* cpvec_second);
 ...
 *          undefined. if cpvec_first == cpvec_second, then return false.
 */
extern bool_t vector_greater(cSTL* pSTL,const vector_t* cpvec_first, const vector_t* cpvec_second);
 ...
 *          undefined. if cpvec_first == cpvec_second, then return true.
 */
extern bool_t vector_greater_equal(cSTL* pSTL,const vector_t* cpvec_first, const vector_t* cpvec_second);
 ...
 */
extern void vector_assign(cSTL* pSTL,vector_t* pvec_dest, const vector_t* cpvec_src);
 ...
 */
extern void vector_assign_range(cSTL* pSTL,vector_t* pvec_vector, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void vector_assign_array(cSTL* pSTL,vector_t* pvec_vector, const void* cpv_array, size_t t_count);
 ...
 */
extern void vector_swap(cSTL* pSTL,vector_t* pvec_first, vector_t* pvec_second);
 ...
 */
extern void vector_insert_range(cSTL* pSTL,
 ...
 */
extern void vector_pop_back(cSTL* pSTL,vector_t* pvec_vector);
 ...
 */
extern vector_iterator_t vector_erase(cSTL* pSTL,vector_t* pvec_vector, vector_iterator_t it_pos);
 ...
 *          behavior is undefined.
 */
extern vector_iterator_t vector_erase_range(cSTL* pSTL,vector_t* pvec_vector, vector_iterator_t it_begin, vector_iterator_t it_end);
 ...
 *          is undefined.
 */
extern void vector_clear(cSTL* pSTL,vector_t* pvec_vector);
 ...
 */
extern void vector_resize(cSTL* pSTL,vector_t* pvec_vector, size_t t_resize);
