 ...
 * Count algorithm.
 */
extern size_t _algo_count(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last, ...);
extern size_t _algo_count_varg(cSTL* pSTL,
 ...
 * Remove algorithm.
 */
extern output_iterator_t _algo_remove_copy(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
    output_iterator_t t_result, ...);
extern output_iterator_t _algo_remove_copy_varg(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
    output_iterator_t t_result, va_list val_elemlist);
extern forward_iterator_t _algo_remove(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last, ...);
extern forward_iterator_t _algo_remove_varg(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last, va_list val_elemlist);

/*
 * Replace algorithm.
 */
extern void _algo_replace_once(cSTL* pSTL,forward_iterator_t t_iterator, ...);
extern void _algo_replace_once_varg(cSTL* pSTL,
    forward_iterator_t t_iterator, va_list val_elemlist);
extern void _algo_replace_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    unary_function_t t_unary_op, ...);
extern void _algo_replace_if_varg(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    unary_function_t t_unary_op, va_list val_elemlist);
extern output_iterator_t _algo_replace_copy_if(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
    output_iterator_t t_result, unary_function_t t_unary_op, ...);
extern output_iterator_t _algo_replace_copy_if_varg(cSTL* pSTL,
    input_iterator_t t_first, input_iterator_t t_last,
    output_iterator_t t_result, unary_function_t t_unary_op,
...
extern forward_iterator_t _algo_upper_bound(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last, ...);
extern forward_iterator_t _algo_upper_bound_if(
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op, ...);
extern forward_iterator_t _algo_upper_bound_if_varg(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op, va_list val_elemlist);
extern range_t _algo_equal_range(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last, ...);
extern range_t _algo_equal_range_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op, ...);
extern range_t _algo_equal_range_if_varg(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op, va_list val_elemlist);
 ...
 * Search algorithm.
 */
extern bool_t _algo_binary_search(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last, ...);
extern bool_t _algo_binary_search_if(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op, ...);
extern bool_t _algo_binary_search_if_varg(cSTL* pSTL,
    forward_iterator_t t_first, forward_iterator_t t_last,
    binary_function_t t_binary_op, va_list val_elemlist);
