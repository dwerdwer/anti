 ...
 */
#define create_multiset(pSTL,...) _create_multiset(pSTL,#__VA_ARGS__) 
 ...
 *          the type of specific element and cpmset_mset must be same, otherwise the behavior is undefined.
 */
#define multiset_insert(pSTL,pmset_mset, elem) _multiset_insert((pSTL),(pmset_mset), (elem))
 ...
 */
extern void multiset_init_copy(cSTL* pSTL,multiset_t* pmset_dest, const multiset_t* cpmset_src);
 ...
 *          is undefined.
 */
extern void multiset_init_copy_range(cSTL* pSTL,multiset_t* pmset_dest, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void multiset_init_copy_array(cSTL* pSTL,multiset_t* pmset_dest, const void* cpv_array, size_t t_count);
 ...
 */
extern void multiset_init_copy_range_ex(cSTL* pSTL,
 ...
 *          is undefined. if bfun_compare == NULL, then use default compare function.
 */
extern void multiset_init_copy_array_ex(cSTL* pSTL,
 ...
 */
extern void multiset_destroy(cSTL* pSTL,multiset_t* pmset_mset);
 ...
 */
extern void multiset_assign(cSTL* pSTL,multiset_t* pmset_dest, const multiset_t* cpmset_src);
 ...
 */
extern void multiset_clear(cSTL* pSTL,multiset_t* pmset_mset);
 ...
 */
extern bool_t multiset_equal(cSTL* pSTL,const multiset_t* cpmset_first, const multiset_t* cpmset_second);
 ...
 */
extern bool_t multiset_not_equal(cSTL* pSTL,const multiset_t* cpmset_first, const multiset_t* cpmset_second);
 ...
 */
extern bool_t multiset_less(cSTL* pSTL,const multiset_t* cpmset_first, const multiset_t* cpmset_second);
 ...
 */
extern bool_t multiset_less_equal(cSTL* pSTL,const multiset_t* cpmset_first, const multiset_t* cpmset_second);
 ...
 *          undefined. if cpmset_first == cpmset_second, then return false.
 */
extern bool_t multiset_greater(cSTL* pSTL,const multiset_t* cpmset_first, const multiset_t* cpmset_second);
 ...
 *          undefined. if cpmset_first == cpmset_second, then return true.
 */
extern bool_t multiset_greater_equal(cSTL* pSTL,const multiset_t* cpmset_first, const multiset_t* cpmset_second);
 ...
 */
extern void multiset_swap(cSTL* pSTL,multiset_t* pmset_first, multiset_t* pmset_second);
 ...
 */
extern void multiset_insert_range(cSTL* pSTL,multiset_t* pmset_mset, iterator_t it_begin, iterator_t it_end);
 ...
 */
extern void multiset_insert_array(cSTL* pSTL,multiset_t* pmset_mset, const void* cpv_array, size_t t_count);
 ...
 */
extern void multiset_erase_pos(cSTL* pSTL,multiset_t* pmset_mset, multiset_iterator_t it_pos);
 ...
 */
extern void multiset_erase_range(cSTL* pSTL,multiset_t* pmset_mset, multiset_iterator_t it_begin, multiset_iterator_t it_end);
