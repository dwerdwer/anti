 ...
 */
extern void _slist_iterator_get_value(cSTL* pSTL,slist_iterator_t it_iter, void* pv_value);
 ...
 *          behavior is undefined.
 */
extern void _slist_iterator_set_value(cSTL* pSTL,slist_iterator_t it_iter, const void* cpv_value);
